...
**Answer:** AAA separates authentication, authorization, and accounting for controlled device access.
...
### 3. Which OSI layer is most closely associated with AAA?

**Answer:** Varies

### 4. Which port or protocol number is important for AAA?

**Answer:** Not applicable

### 5. Name two important AAA terms.

**Answer:** Authentication verifies identity, Authorization decides permitted actions, Accounting records activity

### 6. Is AAA supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring AAA?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify AAA?

**Answer:** the relevant show command and an end-to-end test

### 9. What is one common classroom mistake with AAA?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove AAA works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for AAA.

**Answer:** Follow these core ideas in order: Authentication verifies identity, Authorization decides permitted actions, Accounting records activity. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small AAA lab?
...
### 10. How would you create a useful AAA failure demonstration?
...
### 1. How would AAA change in a larger enterprise?
...
### 2. How would you validate AAA during a change window?
...
### 3. Which hidden dependency can make AAA appear correctly configured but still fail?
...
### 4. How would you secure and monitor AAA in production?
...
### 5. How would you teach AAA without encouraging command memorization?
