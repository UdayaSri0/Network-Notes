---
title: "Subnetting Basics Viva Questions"
...
# Subnetting Basics Viva Questions
...
### 1. What is Subnetting Basics?

**Answer:** Subnetting borrows host bits to create smaller IPv4 networks with controlled size and broadcast scope.

### 2. Why is Subnetting Basics used?
...
### 3. Which OSI layer is most closely associated with Subnetting Basics?

**Answer:** Varies

### 4. Which port or protocol number is important for Subnetting Basics?

**Answer:** Not applicable

### 5. Name two important Subnetting Basics terms.

**Answer:** Choose the required number of subnets or hosts, Select a prefix length, Find the block size, Calculate network broadcast and usable range

### 6. Is Subnetting Basics supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring Subnetting Basics?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify Subnetting Basics?

**Answer:** the relevant show command and an end-to-end test

### 9. What is one common classroom mistake with Subnetting Basics?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove Subnetting Basics works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for Subnetting Basics.

**Answer:** Follow these core ideas in order: Choose the required number of subnets or hosts, Select a prefix length, Find the block size, Calculate network broadcast and usable range. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small Subnetting Basics lab?
...
### 10. How would you create a useful Subnetting Basics failure demonstration?
...
### 1. How would Subnetting Basics change in a larger enterprise?
...
### 2. How would you validate Subnetting Basics during a change window?
...
### 3. Which hidden dependency can make Subnetting Basics appear correctly configured but still fail?
...
### 4. How would you secure and monitor Subnetting Basics in production?
...
### 5. How would you teach Subnetting Basics without encouraging command memorization?
