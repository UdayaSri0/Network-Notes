...
> [!abstract]
> A floating static route uses a higher administrative distance so it activates only when a preferred route disappears.
...
1. Configure the same destination as the primary path
2. Set a worse administrative distance
3. Test primary failure and recovery

## 5. Important Terminology

- **Key idea 1:** Configure the same destination as the primary path
- **Key idea 2:** Set a worse administrative distance
- **Key idea 3:** Test primary failure and recovery
...
1. What problem does Floating Static Route solve?
...
- **What:** A floating static route uses a higher administrative distance so it activates only when a preferred route disappears.
