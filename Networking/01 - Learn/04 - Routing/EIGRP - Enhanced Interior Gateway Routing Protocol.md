...
> [!abstract]
> EIGRP is an advanced distance-vector protocol that uses DUAL to select loop-free successor and feasible-successor paths.
...
1. Neighbors exchange topology information
2. DUAL selects the successor
3. Feasibility condition identifies safe backups
4. Composite metrics compare paths

## 5. Important Terminology

- **Key idea 1:** Neighbors exchange topology information
- **Key idea 2:** DUAL selects the successor
- **Key idea 3:** Feasibility condition identifies safe backups
- **Key idea 4:** Composite metrics compare paths
...
1. What problem does EIGRP solve?
...
- **What:** EIGRP is an advanced distance-vector protocol that uses DUAL to select loop-free successor and feasible-successor paths.
