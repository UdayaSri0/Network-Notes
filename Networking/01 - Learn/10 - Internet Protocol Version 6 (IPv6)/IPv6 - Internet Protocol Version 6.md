...
> [!abstract]
> IPv6 uses 128-bit addressing, extension headers, multicast, neighbor discovery, and large hierarchical prefixes.
...
1. Use hexadecimal colon notation
2. Enable IPv6 routing on routers
3. Assign /64 LAN prefixes
4. Use NDP instead of ARP

## 5. Important Terminology

- **Key idea 1:** Use hexadecimal colon notation
- **Key idea 2:** Enable IPv6 routing on routers
- **Key idea 3:** Assign /64 LAN prefixes
- **Key idea 4:** Use NDP instead of ARP
...
1. What problem does IPv6 solve?
...
- **What:** IPv6 uses 128-bit addressing, extension headers, multicast, neighbor discovery, and large hierarchical prefixes.
