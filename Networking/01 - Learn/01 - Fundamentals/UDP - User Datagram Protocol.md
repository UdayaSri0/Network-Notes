...
> [!abstract]
> UDP provides connectionless transport with low overhead and no built-in delivery guarantee.
...
1. No handshake is required
2. Datagrams are independent
3. Applications add reliability when needed
4. Useful for real-time and simple request-response services

## 5. Important Terminology

- **Key idea 1:** No handshake is required
- **Key idea 2:** Datagrams are independent
- **Key idea 3:** Applications add reliability when needed
- **Key idea 4:** Useful for real-time and simple request-response services
...
- **What:** UDP provides connectionless transport with low overhead and no built-in delivery guarantee.
