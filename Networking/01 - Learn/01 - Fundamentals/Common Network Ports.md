...
> [!abstract]
> Well-known port numbers identify common application and infrastructure services.
...
1. Servers listen on known destination ports
2. Clients normally use temporary source ports
3. TCP and UDP port spaces are separate

## 5. Important Terminology

- **Key idea 1:** Servers listen on known destination ports
- **Key idea 2:** Clients normally use temporary source ports
- **Key idea 3:** TCP and UDP port spaces are separate
...
1. What problem does Common Network Ports solve?
...
- **What:** Well-known port numbers identify common application and infrastructure services.
