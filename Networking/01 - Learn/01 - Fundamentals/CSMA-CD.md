...
> [!abstract]
> CSMA/CD is the legacy half-duplex Ethernet method for detecting and recovering from collisions.
...
2. Detect a collision while sending
3. Send a jam signal and back off randomly
4. Retry after the timer

## 5. Important Terminology

- **Key idea 1:** Listen before transmitting
- **Key idea 2:** Detect a collision while sending
- **Key idea 3:** Send a jam signal and back off randomly
- **Key idea 4:** Retry after the timer
...
1. What problem does CSMA-CD solve?
...
- **What:** CSMA/CD is the legacy half-duplex Ethernet method for detecting and recovering from collisions.
