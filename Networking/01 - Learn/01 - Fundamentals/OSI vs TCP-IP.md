...
> [!abstract]
> OSI is a seven-layer reference model while TCP/IP is the practical four-layer architecture used by Internet protocols.
...
1. OSI separates Session and Presentation functions
2. TCP-IP combines upper-layer functions into Application
3. Both provide a layered troubleshooting vocabulary

## 5. Important Terminology

- **Key idea 1:** OSI separates Session and Presentation functions
- **Key idea 2:** TCP-IP combines upper-layer functions into Application
- **Key idea 3:** Both provide a layered troubleshooting vocabulary
...
1. What problem does OSI vs TCP-IP solve?
...
- **What:** OSI is a seven-layer reference model while TCP/IP is the practical four-layer architecture used by Internet protocols.
