...
> [!abstract]
> Subnetting borrows host bits to create smaller IPv4 networks with controlled size and broadcast scope.
...
1. Choose the required number of subnets or hosts
2. Select a prefix length
3. Find the block size
4. Calculate network broadcast and usable range

## 5. Important Terminology

- **Key idea 1:** Choose the required number of subnets or hosts
- **Key idea 2:** Select a prefix length
- **Key idea 3:** Find the block size
- **Key idea 4:** Calculate network broadcast and usable range
...
1. What problem does Subnetting Basics solve?
...
- **What:** Subnetting borrows host bits to create smaller IPv4 networks with controlled size and broadcast scope.
