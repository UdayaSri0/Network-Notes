---
title: "IPv4 - Internet Protocol Version 4 Addressing"
...
> [!abstract]
> IPv4 uses 32-bit logical addresses and prefix lengths to identify networks and hosts.
...
1. Separate network and host portions with the mask
2. Use unique host addresses in each subnet
3. Route packets between different subnets

## 5. Important Terminology

- **Key idea 1:** Separate network and host portions with the mask
- **Key idea 2:** Use unique host addresses in each subnet
- **Key idea 3:** Route packets between different subnets
...
1. What problem does IPv4 Addressing solve?
...
- **What:** IPv4 uses 32-bit logical addresses and prefix lengths to identify networks and hosts.
