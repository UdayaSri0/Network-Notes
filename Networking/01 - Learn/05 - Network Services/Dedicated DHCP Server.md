...
> [!abstract]
> A dedicated DHCP server centralizes address pools for multiple VLANs and is the preferred design for the enterprise Packet Tracer labs.
...
1. Give the server a static address
2. Create one correctly scoped pool per VLAN
3. Configure each pool gateway and DNS values
4. Use relay on remote client gateways

## 5. Important Terminology

- **Key idea 1:** Give the server a static address
- **Key idea 2:** Create one correctly scoped pool per VLAN
- **Key idea 3:** Configure each pool gateway and DNS values
- **Key idea 4:** Use relay on remote client gateways
...
1. What problem does Dedicated DHCP Server solve?
...
- **What:** A dedicated DHCP server centralizes address pools for multiple VLANs and is the preferred design for the enterprise Packet Tracer labs.
