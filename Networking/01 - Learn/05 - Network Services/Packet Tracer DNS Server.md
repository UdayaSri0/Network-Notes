---
title: "Packet Tracer DNS Server"
...
> [!abstract]
> Packet Tracer Server-PT can provide basic DNS records for classroom name-resolution labs.
...
1. Configure a static server address
2. Enable DNS under Services
3. Create A records mapping names to IPv4 addresses
4. Point clients to the server

## 5. Important Terminology

- **Key idea 1:** Configure a static server address
- **Key idea 2:** Enable DNS under Services
- **Key idea 3:** Create A records mapping names to IPv4 addresses
- **Key idea 4:** Point clients to the server
...
1. What problem does Packet Tracer DNS Server solve?
...
- **What:** Packet Tracer Server-PT can provide basic DNS records for classroom name-resolution labs.
