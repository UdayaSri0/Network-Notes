...
> [!abstract]
> DORA describes DHCP Discover, Offer, Request, and Acknowledge messages used to obtain an IPv4 lease.
...
1. Discover locates servers
2. Offer proposes addressing
3. Request identifies the chosen offer
4. Acknowledge confirms the lease

## 5. Important Terminology

- **Key idea 1:** Discover locates servers
- **Key idea 2:** Offer proposes addressing
- **Key idea 3:** Request identifies the chosen offer
- **Key idea 4:** Acknowledge confirms the lease
...
1. What problem does DHCP DORA Process solve?
...
- **What:** DORA describes DHCP Discover, Offer, Request, and Acknowledge messages used to obtain an IPv4 lease.
