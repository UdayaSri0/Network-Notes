...
> [!abstract]
> Cisco IOS can act as a DHCP server by excluding infrastructure addresses and defining one pool per client subnet.
...
2. Create a pool matching the subnet
3. Provide the correct default gateway
4. Verify bindings and conflicts

## 5. Important Terminology

- **Key idea 1:** Exclude static addresses
- **Key idea 2:** Create a pool matching the subnet
- **Key idea 3:** Provide the correct default gateway
- **Key idea 4:** Verify bindings and conflicts
...
1. What problem does Cisco Router DHCP solve?
...
- **What:** Cisco IOS can act as a DHCP server by excluding infrastructure addresses and defining one pool per client subnet.
