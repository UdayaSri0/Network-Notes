...
> [!abstract]
> PortFast marks an endpoint-facing access port as an edge so it can enter forwarding without normal STP delay.
...
1. Use only toward endpoints
2. It does not disable STP
3. Pair with BPDU Guard

## 5. Important Terminology

- **Key idea 1:** Use only toward endpoints
- **Key idea 2:** It does not disable STP
- **Key idea 3:** Pair with BPDU Guard
...
1. What problem does PortFast solve?
...
- **What:** PortFast marks an endpoint-facing access port as an edge so it can enter forwarding without normal STP delay.
