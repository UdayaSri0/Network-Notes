---
title: "Cisco Troubleshooting Method"
...
> [!abstract]
> Cisco troubleshooting combines layered reasoning with device state, path tracing, comparison, and controlled change.
...
1. Bottom-up starts at media
2. Top-down starts at the application
3. Divide-and-conquer starts near Layer 3
4. Follow-the-path finds the first failed hop
5. Comparison finds configuration drift

## 5. Important Terminology

- **Key idea 1:** Bottom-up starts at media
- **Key idea 2:** Top-down starts at the application
- **Key idea 3:** Divide-and-conquer starts near Layer 3
- **Key idea 4:** Follow-the-path finds the first failed hop
- **Key idea 5:** Comparison finds configuration drift
...
1. What problem does Cisco Troubleshooting Method solve?
...
- **What:** Cisco troubleshooting combines layered reasoning with device state, path tracing, comparison, and controlled change.
