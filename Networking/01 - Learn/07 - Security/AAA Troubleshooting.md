...
> [!abstract]
> AAA troubleshooting protects recovery access while checking method lists, server reachability, shared secrets, user databases, and line application.
...
1. Keep a local recovery account
2. Verify IP and time first
3. Compare shared secrets
4. Test method order before closing the session

## 5. Important Terminology

- **Key idea 1:** Keep a local recovery account
- **Key idea 2:** Verify IP and time first
- **Key idea 3:** Compare shared secrets
- **Key idea 4:** Test method order before closing the session
...
1. What problem does AAA Troubleshooting solve?
...
- **What:** AAA troubleshooting protects recovery access while checking method lists, server reachability, shared secrets, user databases, and line application.
