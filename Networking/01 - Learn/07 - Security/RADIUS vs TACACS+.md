...
> [!abstract]
> RADIUS commonly supports network access with UDP, while TACACS+ commonly supports device administration with TCP and granular command authorization.
...
1. RADIUS combines authentication and authorization
2. TACACS+ separates AAA functions
3. Transport and encryption coverage differ

## 5. Important Terminology

- **Key idea 1:** RADIUS combines authentication and authorization
- **Key idea 2:** TACACS+ separates AAA functions
- **Key idea 3:** Transport and encryption coverage differ
...
1. What problem does RADIUS vs TACACS+ solve?
...
- **What:** RADIUS commonly supports network access with UDP, while TACACS+ commonly supports device administration with TCP and granular command authorization.
