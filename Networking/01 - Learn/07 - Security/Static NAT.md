...
1. Choose one internal host
2. Reserve one translated address
3. Configure inside and outside roles
4. Verify the fixed translation

## 5. Important Terminology

- **Key idea 1:** Choose one internal host
- **Key idea 2:** Reserve one translated address
- **Key idea 3:** Configure inside and outside roles
- **Key idea 4:** Verify the fixed translation
...
1. What problem does Static NAT solve?
...
- **What:** Static NAT creates a permanent one-to-one mapping between an inside local and inside global address.
