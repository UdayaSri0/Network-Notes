...
> [!abstract]
> Dynamic ARP Inspection validates ARP messages against trusted bindings to reduce ARP spoofing.
...
2. Enable DAI per VLAN
3. Trust only infrastructure links
4. Validate untrusted ARP against bindings

## 5. Important Terminology

- **Key idea 1:** Enable DHCP snooping first
- **Key idea 2:** Enable DAI per VLAN
- **Key idea 3:** Trust only infrastructure links
- **Key idea 4:** Validate untrusted ARP against bindings
...
1. What problem does Dynamic ARP Inspection solve?
...
- **What:** Dynamic ARP Inspection validates ARP messages against trusted bindings to reduce ARP spoofing.
