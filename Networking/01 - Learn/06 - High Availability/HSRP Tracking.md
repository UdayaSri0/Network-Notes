...
> [!abstract]
> HSRP tracking lowers gateway priority when an upstream interface or tracked object fails.
...
1. Choose a failure that affects real reachability
2. Set a decrement large enough to change preference
3. Use preemption to move roles
4. Test failure and recovery

## 5. Important Terminology

- **Key idea 1:** Choose a failure that affects real reachability
- **Key idea 2:** Set a decrement large enough to change preference
- **Key idea 3:** Use preemption to move roles
- **Key idea 4:** Test failure and recovery
...
1. What problem does HSRP Tracking solve?
...
- **What:** HSRP tracking lowers gateway priority when an upstream interface or tracked object fails.
