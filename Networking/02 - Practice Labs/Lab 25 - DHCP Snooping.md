...
# Lab 25 - DHCP Snooping

> [!abstract]
> Block rogue DHCP offers and build trusted client bindings.
...
2 switches, legitimate server, rogue server, 2 PCs
...
1. Enable snooping for the client VLAN.
2. Trust only the legitimate server uplink.
3. Leave endpoint and rogue ports untrusted.
4. Compare client leases before and after protection.
...
|---|---|---|
| Test 1 | Legitimate lease succeeds | Success |
| Test 2 | Rogue offer is blocked | Success |
| Test 3 | Binding table populates | Success |
