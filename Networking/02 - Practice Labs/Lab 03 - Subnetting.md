...
> [!abstract]
> Design and implement subnets derived from one /24 block.
...
1. Divide 192.168.1.0/24 into /27 subnets.
2. Document network, usable range, and broadcast.
3. Assign two subnets to router interfaces and endpoints.
4. Verify no duplicate or out-of-range addresses.
...
|---|---|---|
| Test 1 | All hosts reach their gateway | Success |
| Test 2 | Inter-subnet ping succeeds | Success |
