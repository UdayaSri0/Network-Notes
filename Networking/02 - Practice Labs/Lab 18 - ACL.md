...
> [!abstract]
> Use standard and extended ACLs to permit required traffic and block one defined flow.
...
2 routers, 2 switches, 3 PCs, 1 server
...
1. Document the desired traffic matrix.
2. Write the ACL in evaluation order.
3. Apply it once in the correct direction.
4. Test permitted and denied flows and inspect counters.
...
|---|---|---|
| Test 1 | Allowed flows succeed | Success |
| Test 2 | Denied flow fails | Success |
| Test 3 | ACL hit counts increase | Success |
