...
**Answer:** Syslog sends timestamped event messages to local or remote logging destinations.

### 2. Why is Syslog used?
...
### 3. Which OSI layer is most closely associated with Syslog?

**Answer:** See the protocol overview

### 4. Which port or protocol number is important for Syslog?

**Answer:** See the protocol overview

### 5. Name two important Syslog terms.

**Answer:** facility, severity, mnemonic, timestamp

### 6. Is Syslog supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring Syslog?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify Syslog?

**Answer:** show logging

### 9. What is one common classroom mistake with Syslog?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove Syslog works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for Syslog.

**Answer:** Follow these core ideas in order: facility, severity, mnemonic, timestamp. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small Syslog lab?
...
### 10. How would you create a useful Syslog failure demonstration?
...
### 1. How would Syslog change in a larger enterprise?
...
### 2. How would you validate Syslog during a change window?
...
### 3. Which hidden dependency can make Syslog appear correctly configured but still fail?
...
### 4. How would you secure and monitor Syslog in production?
...
### 5. How would you teach Syslog without encouraging command memorization?
