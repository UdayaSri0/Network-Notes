---
title: "Lab 11 - Central DHCP Server"
...
# Lab 11 - Central DHCP Server

> [!abstract]
> Serve multiple VLANs from dedicated DHCP server 200.100.10.5 using relay.
...
1 multilayer switch or router, 2 switches, Server0, 6 PCs
...
1. Give Server0 static address 200.100.10.5.
2. Create one DHCP pool per client VLAN.
3. Configure ip helper-address on every remote client gateway.
4. Use DHCP on clients and inspect leases.
...
|---|---|---|
| Test 1 | Every client receives the correct subnet | Success |
| Test 2 | Gateways and DNS values match the pool | Success |
| Test 3 | Inter-VLAN routing works | Success |
