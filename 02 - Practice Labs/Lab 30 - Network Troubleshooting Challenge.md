---
title: "Lab 30 - Network Troubleshooting Challenge"
...
> [!abstract]
> Diagnose a deliberately broken enterprise topology without erasing configurations.
...
Use a copy of Lab 29 with seeded faults
...
1. Record symptoms before changing anything.
2. Use bottom-up and follow-the-path methods.
3. Find faults across VLANs, trunks, routing, DHCP, DNS, ACL, NAT, STP, and management.
4. Make one controlled repair at a time.
5. Complete an evidence and verification report.
...
|---|---|---|
| Test 1 | All required tests recover | Success |
| Test 2 | Every repair has evidence | Success |
| Test 3 | No unrelated configuration was deleted | Success |
