...
> [!abstract]
> Connect three router LANs with explicit static routes.
...
1. Address LAN and point-to-point links.
2. Verify directly connected neighbors.
3. Add destination routes on every router.
4. Trace end-to-end traffic.
...
|---|---|---|
| Test 1 | All remote LANs appear as static routes | Success |
| Test 2 | PC1 reaches PC3 | Success |
