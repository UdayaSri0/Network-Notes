---
title: "Multilayer Switch Routing"
...
> [!abstract]
> Multilayer switch routing combines Layer 2 VLAN forwarding with Layer 3 route decisions.
...
1. Enable ip routing
2. Use SVIs for VLAN gateways
3. Use no switchport for routed links
4. Add static or dynamic routes as required

## 5. Important Terminology

- **Key idea 1:** Enable ip routing
- **Key idea 2:** Use SVIs for VLAN gateways
- **Key idea 3:** Use no switchport for routed links
- **Key idea 4:** Add static or dynamic routes as required
...
1. What problem does Multilayer Switch Routing solve?
...
- **What:** Multilayer switch routing combines Layer 2 VLAN forwarding with Layer 3 route decisions.
