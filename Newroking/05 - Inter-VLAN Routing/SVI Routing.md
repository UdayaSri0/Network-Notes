...
> [!abstract]
> SVI routing uses one logical VLAN interface per subnet to provide inter-VLAN default gateways.
...
1. Create the VLAN
2. Configure the SVI address
3. Ensure the SVI line protocol is up
4. Enable ip routing

## 5. Important Terminology

- **Key idea 1:** Create the VLAN
- **Key idea 2:** Configure the SVI address
- **Key idea 3:** Ensure the SVI line protocol is up
- **Key idea 4:** Enable ip routing
...
1. What problem does SVI Routing solve?
...
- **What:** SVI routing uses one logical VLAN interface per subnet to provide inter-VLAN default gateways.
