...
> [!abstract]
> A routed switch port behaves as a Layer 3 interface instead of a VLAN switchport.
...
1. Remove Layer 2 mode with no switchport
2. Assign an IP address and mask
3. Enable routing and the interface

## 5. Important Terminology

- **Key idea 1:** Remove Layer 2 mode with no switchport
- **Key idea 2:** Assign an IP address and mask
- **Key idea 3:** Enable routing and the interface
...
1. What problem does Routed Port solve?
...
- **What:** A routed switch port behaves as a Layer 3 interface instead of a VLAN switchport.
