...
**Answer:** DHCP automatically leases IPv4 addressing information such as address, mask, gateway, DNS server, and lease time.
...
### 3. Which OSI layer is most closely associated with DHCP?

**Answer:** Layer 7

### 4. Which port or protocol number is important for DHCP?

**Answer:** UDP 67 server, UDP 68 client

### 5. Name two important DHCP terms.

**Answer:** A client broadcasts discovery, A server offers a lease, The client requests one offer, The server acknowledges the binding

### 6. Is DHCP supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring DHCP?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify DHCP?

**Answer:** the relevant show command and an end-to-end test

### 9. What is one common classroom mistake with DHCP?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove DHCP works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for DHCP.

**Answer:** Follow these core ideas in order: A client broadcasts discovery, A server offers a lease, The client requests one offer, The server acknowledges the binding. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small DHCP lab?
...
### 10. How would you create a useful DHCP failure demonstration?
...
### 1. How would DHCP change in a larger enterprise?
...
### 2. How would you validate DHCP during a change window?
...
### 3. Which hidden dependency can make DHCP appear correctly configured but still fail?
...
### 4. How would you secure and monitor DHCP in production?
...
### 5. How would you teach DHCP without encouraging command memorization?
