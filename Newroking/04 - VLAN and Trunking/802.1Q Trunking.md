...
> [!abstract]
> IEEE 802.1Q adds VLAN identification to Ethernet frames so one link can carry multiple VLANs.
...
1. Tagged frames identify their VLAN
2. Native VLAN traffic is normally untagged
3. Allowed lists control which VLANs cross the trunk

## 5. Important Terminology

- **Key idea 1:** Tagged frames identify their VLAN
- **Key idea 2:** Native VLAN traffic is normally untagged
- **Key idea 3:** Allowed lists control which VLANs cross the trunk
...
1. What problem does 802.1Q Trunking solve?
...
- **What:** IEEE 802.1Q adds VLAN identification to Ethernet frames so one link can carry multiple VLANs.
