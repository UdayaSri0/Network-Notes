...
> [!abstract]
> RIP is a distance-vector routing protocol that uses hop count and permits at most 15 routed hops.
...
1. Routers periodically advertise route vectors
2. Lowest hop count wins
3. Split horizon and route poisoning reduce loops
4. RIPv2 carries masks and multicast updates

## 5. Important Terminology

- **Key idea 1:** Routers periodically advertise route vectors
- **Key idea 2:** Lowest hop count wins
- **Key idea 3:** Split horizon and route poisoning reduce loops
- **Key idea 4:** RIPv2 carries masks and multicast updates
...
- **What:** RIP is a distance-vector routing protocol that uses hop count and permits at most 15 routed hops.
