...
> [!abstract]
> A default route matches destinations that have no more-specific route.
...
1. Use 0.0.0.0/0 in IPv4
2. Point toward an upstream router
3. Confirm a recursive next hop is reachable

## 5. Important Terminology

- **Key idea 1:** Use 0.0.0.0/0 in IPv4
- **Key idea 2:** Point toward an upstream router
- **Key idea 3:** Confirm a recursive next hop is reachable
...
1. What problem does Default Route solve?
...
- **What:** A default route matches destinations that have no more-specific route.
