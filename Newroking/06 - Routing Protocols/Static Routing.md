...
> [!abstract]
> A static route is manually configured reachability for a destination prefix.
...
1. Match the destination prefix
2. Point to a reachable next hop or exit interface
3. Use route tables and pings to verify

## 5. Important Terminology

- **Key idea 1:** Match the destination prefix
- **Key idea 2:** Point to a reachable next hop or exit interface
- **Key idea 3:** Use route tables and pings to verify
...
1. What problem does Static Routing solve?
...
- **What:** A static route is manually configured reachability for a destination prefix.
