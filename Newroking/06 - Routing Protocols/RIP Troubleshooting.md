...
> [!abstract]
> RIP troubleshooting checks interface networks, version, auto-summary, passive interfaces, and route-table installation.
...
1. Verify connected networks
2. Compare RIP versions
3. Check advertised network statements
4. Inspect administrative distance and better routes

## 5. Important Terminology

- **Key idea 1:** Verify connected networks
- **Key idea 2:** Compare RIP versions
- **Key idea 3:** Check advertised network statements
- **Key idea 4:** Inspect administrative distance and better routes
...
1. What problem does RIP Troubleshooting solve?
...
- **What:** RIP troubleshooting checks interface networks, version, auto-summary, passive interfaces, and route-table installation.
