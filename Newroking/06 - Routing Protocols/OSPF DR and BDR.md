...
> [!abstract]
> OSPF elects a designated router and backup designated router on multiaccess segments to reduce adjacency and flooding overhead.
...
1. Interface priority influences election
2. Router ID breaks priority ties
3. Priority zero prevents candidacy
4. Elections are non-preemptive

## 5. Important Terminology

- **Key idea 1:** Interface priority influences election
- **Key idea 2:** Router ID breaks priority ties
- **Key idea 3:** Priority zero prevents candidacy
- **Key idea 4:** Elections are non-preemptive
...
1. What problem does OSPF DR and BDR solve?
...
- **What:** OSPF elects a designated router and backup designated router on multiaccess segments to reduce adjacency and flooding overhead.
