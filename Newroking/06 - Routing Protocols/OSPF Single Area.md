...
> [!abstract]
> Single-area OSPF places every participating interface in one area, commonly area 0.
...
2. Match interfaces with network and wildcard statements
3. Use the same area on shared links
4. Verify Full neighbors

## 5. Important Terminology

- **Key idea 1:** Assign a unique router ID
- **Key idea 2:** Match interfaces with network and wildcard statements
- **Key idea 3:** Use the same area on shared links
- **Key idea 4:** Verify Full neighbors
...
1. What problem does OSPF Single Area solve?
...
- **What:** Single-area OSPF places every participating interface in one area, commonly area 0.
