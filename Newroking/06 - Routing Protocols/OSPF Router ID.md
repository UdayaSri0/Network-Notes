...
> [!abstract]
> The OSPF router ID is a 32-bit identifier used in adjacencies and link-state advertisements.
...
1. Manual router-id is most predictable
2. Otherwise IOS selects a loopback or active interface address
3. Changing it can require process restart

## 5. Important Terminology

- **Key idea 1:** Manual router-id is most predictable
- **Key idea 2:** Otherwise IOS selects a loopback or active interface address
- **Key idea 3:** Changing it can require process restart
...
1. What problem does OSPF Router ID solve?
...
- **What:** The OSPF router ID is a 32-bit identifier used in adjacencies and link-state advertisements.
