...
> [!abstract]
> PAP is a simple PPP authentication method that sends credentials without strong protection.
...
1. The requester repeatedly sends a username and password
2. The peer accepts or rejects
3. CHAP is preferable where available

## 5. Important Terminology

- **Key idea 1:** The requester repeatedly sends a username and password
- **Key idea 2:** The peer accepts or rejects
- **Key idea 3:** CHAP is preferable where available
...
1. What problem does PPP PAP solve?
...
- **What:** PAP is a simple PPP authentication method that sends credentials without strong protection.
