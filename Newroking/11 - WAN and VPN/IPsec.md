...
> [!abstract]
> IPsec protects IP traffic with authentication, integrity, anti-replay controls, and optional encryption.
...
1. IKE negotiates keys and policies
2. ESP commonly protects payloads
3. Security associations are directional
4. Selectors identify protected traffic

## 5. Important Terminology

- **Key idea 1:** IKE negotiates keys and policies
- **Key idea 2:** ESP commonly protects payloads
- **Key idea 3:** Security associations are directional
- **Key idea 4:** Selectors identify protected traffic
...
| IP protocol number | ESP 50, AH 51 |
...
1. What problem does IPsec solve?
...
- **What:** IPsec protects IP traffic with authentication, integrity, anti-replay controls, and optional encryption.
