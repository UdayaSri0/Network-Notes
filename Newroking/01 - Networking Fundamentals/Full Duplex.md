...
> [!abstract]
> Full duplex allows simultaneous transmission and reception on a point-to-point Ethernet link.
...
1. Separate transmit and receive paths operate concurrently
2. Collisions do not occur
3. Both ends must negotiate or be configured compatibly

## 5. Important Terminology

- **Key idea 1:** Separate transmit and receive paths operate concurrently
- **Key idea 2:** Collisions do not occur
- **Key idea 3:** Both ends must negotiate or be configured compatibly
...
1. What problem does Full Duplex solve?
...
- **What:** Full duplex allows simultaneous transmission and reception on a point-to-point Ethernet link.
