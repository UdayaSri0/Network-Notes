...
> [!abstract]
> Half duplex allows transmission in only one direction at a time and uses collision handling on shared Ethernet.
...
2. Collisions reduce performance
3. Modern switched networks normally use full duplex

## 5. Important Terminology

- **Key idea 1:** Only one station transmits at a time
- **Key idea 2:** Collisions reduce performance
- **Key idea 3:** Modern switched networks normally use full duplex
...
1. What problem does Half Duplex solve?
...
- **What:** Half duplex allows transmission in only one direction at a time and uses collision handling on shared Ethernet.
