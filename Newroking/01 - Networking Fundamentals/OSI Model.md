...
> [!abstract]
> The OSI model divides network communication into seven layers so functions and faults can be discussed consistently.
...
1. Physical transmits bits through media
2. Data Link frames local traffic and uses MAC addresses
3. Network routes packets with logical addresses
4. Transport provides end-to-end delivery
5. Session manages conversations
6. Presentation transforms and protects data
7. Application provides user-facing network services

## 5. Important Terminology

- **Key idea 1:** Physical transmits bits through media
- **Key idea 2:** Data Link frames local traffic and uses MAC addresses
- **Key idea 3:** Network routes packets with logical addresses
- **Key idea 4:** Transport provides end-to-end delivery
- **Key idea 5:** Session manages conversations
...
1. What problem does OSI Model solve?
...
- **What:** The OSI model divides network communication into seven layers so functions and faults can be discussed consistently.
