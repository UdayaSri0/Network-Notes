...
> [!abstract]
> The TCP/IP model groups real-world networking functions into Network Access, Internet, Transport, and Application layers.
...
1. Network Access moves frames on the local medium
2. Internet uses IP to deliver packets between networks
3. Transport uses TCP or UDP between applications
4. Application contains user and infrastructure services

## 5. Important Terminology

- **Key idea 1:** Network Access moves frames on the local medium
- **Key idea 2:** Internet uses IP to deliver packets between networks
- **Key idea 3:** Transport uses TCP or UDP between applications
- **Key idea 4:** Application contains user and infrastructure services
...
1. What problem does TCP-IP Model solve?
...
- **What:** The TCP/IP model groups real-world networking functions into Network Access, Internet, Transport, and Application layers.
