...
> [!abstract]
> Unicast communication sends a frame or packet from one source to one destination.
...
1. The destination identifies one receiver
2. Switches forward known unicast frames toward one port
3. Routers forward unicast packets using route tables

## 5. Important Terminology

- **Key idea 1:** The destination identifies one receiver
- **Key idea 2:** Switches forward known unicast frames toward one port
- **Key idea 3:** Routers forward unicast packets using route tables
...
1. What problem does Unicast solve?
...
- **What:** Unicast communication sends a frame or packet from one source to one destination.
