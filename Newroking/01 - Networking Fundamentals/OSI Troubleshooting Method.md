---
title: "OSI Troubleshooting Method"
...
> [!abstract]
> The OSI troubleshooting method isolates faults by testing one layer at a time instead of changing unrelated settings.
...
It is used in networking fundamentals designs, Cisco IOS teaching labs, operational verification, and fault isolation. The exact platform support depends on the selected switch, router, server, or endpoint.

## 4. How It Works

1. Check power cable and link at Layer 1
2. Check VLAN MAC and framing at Layer 2
3. Check IP gateway and routing at Layer 3
4. Check ports and sessions at Layer 4
5. Check applications and names at upper layers

## 5. Important Terminology

- **Key idea 1:** Check power cable and link at Layer 1
- **Key idea 2:** Check VLAN MAC and framing at Layer 2
- **Key idea 3:** Check IP gateway and routing at Layer 3
- **Key idea 4:** Check ports and sessions at Layer 4
- **Key idea 5:** Check applications and names at upper layers
...
1. What problem does OSI Troubleshooting Method solve?
...
- **What:** The OSI troubleshooting method isolates faults by testing one layer at a time instead of changing unrelated settings.
