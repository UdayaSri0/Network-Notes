...
> [!abstract]
> Ethernet defines common wired LAN framing, MAC addressing, link operation, and media behavior.
...
1. Endpoints and switches exchange Ethernet frames
2. Switches learn source MAC addresses
3. Destination MAC addresses control local forwarding

## 5. Important Terminology

- **Key idea 1:** Endpoints and switches exchange Ethernet frames
- **Key idea 2:** Switches learn source MAC addresses
- **Key idea 3:** Destination MAC addresses control local forwarding
...
- **What:** Ethernet defines common wired LAN framing, MAC addressing, link operation, and media behavior.
