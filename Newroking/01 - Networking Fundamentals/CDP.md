...
> [!abstract]
> Cisco Discovery Protocol advertises Cisco device identity, platform, port, and addressing information to directly connected neighbors.
...
1. CDP operates only on the local link
2. Cisco devices periodically advertise information
3. Neighbor tables assist topology discovery

## 5. Important Terminology

- **Key idea 1:** CDP operates only on the local link
- **Key idea 2:** Cisco devices periodically advertise information
- **Key idea 3:** Neighbor tables assist topology discovery
...
- **What:** Cisco Discovery Protocol advertises Cisco device identity, platform, port, and addressing information to directly connected neighbors.
