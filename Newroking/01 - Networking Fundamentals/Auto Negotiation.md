...
> [!abstract]
> Ethernet auto-negotiation lets link partners select compatible speed and duplex settings.
...
1. Partners advertise capabilities
2. The highest common mode is selected
3. A mismatch can cause errors and poor performance

## 5. Important Terminology

- **Key idea 1:** Partners advertise capabilities
- **Key idea 2:** The highest common mode is selected
- **Key idea 3:** A mismatch can cause errors and poor performance
...
1. What problem does Auto Negotiation solve?
...
- **What:** Ethernet auto-negotiation lets link partners select compatible speed and duplex settings.
