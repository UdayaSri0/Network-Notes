...
> [!abstract]
> ARP resolves an IPv4 address to a local Ethernet MAC address.
...
3. The owner sends a unicast ARP reply
4. The mapping is cached temporarily

## 5. Important Terminology

- **Key idea 1:** The sender checks its ARP cache
- **Key idea 2:** An ARP request is broadcast
- **Key idea 3:** The owner sends a unicast ARP reply
- **Key idea 4:** The mapping is cached temporarily
...
- **What:** ARP resolves an IPv4 address to a local Ethernet MAC address.
