---
title: "Cisco Switch Basic Configuration"
...
> [!abstract]
> A baseline switch configuration establishes device identity, secure management, access ports, and saved configuration.
...
1. Set hostname and credentials
2. Create a management VLAN and SVI
3. Configure the default gateway on Layer 2 switches
4. Verify ports and save

## 5. Important Terminology

- **Key idea 1:** Set hostname and credentials
- **Key idea 2:** Create a management VLAN and SVI
- **Key idea 3:** Configure the default gateway on Layer 2 switches
- **Key idea 4:** Verify ports and save
...
1. What problem does Cisco Switch Basic Configuration solve?
...
- **What:** A baseline switch configuration establishes device identity, secure management, access ports, and saved configuration.
