...
> [!abstract]
> IPv6 defines global unicast, unique local, link-local, multicast, anycast, loopback, and unspecified address uses.
...
1. Global unicast is Internet-routable
2. Link-local FE80::/10 supports local control
3. Multicast replaces broadcast
4. ::1 is loopback

## 5. Important Terminology

- **Key idea 1:** Global unicast is Internet-routable
- **Key idea 2:** Link-local FE80::/10 supports local control
- **Key idea 3:** Multicast replaces broadcast
- **Key idea 4:** ::1 is loopback
...
1. What problem does IPv6 Address Types solve?
...
- **What:** IPv6 defines global unicast, unique local, link-local, multicast, anycast, loopback, and unspecified address uses.
