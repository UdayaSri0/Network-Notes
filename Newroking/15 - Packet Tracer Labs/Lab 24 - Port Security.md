...
> [!abstract]
> Restrict an access port with sticky MAC learning and a defined violation action.
...
1. Configure a static access port.
2. Enable sticky learning and maximum addresses.
3. Choose restrict or shutdown.
4. Move a different PC to the port and inspect the result.
...
|---|---|---|
| Test 1 | Authorized PC works | Success |
| Test 2 | Violation counter increases | Success |
