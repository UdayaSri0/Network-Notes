...
> [!abstract]
> Form single-area OSPF adjacencies and exchange LAN routes.
...
1. Address all links and verify direct reachability.
2. Assign unique router IDs.
3. Advertise interfaces into area 0 with correct wildcards.
4. Verify Full neighbors and O routes.
...
|---|---|---|
| Test 1 | Neighbors reach Full | Success |
| Test 2 | All LAN routes appear as O | Success |
| Test 3 | PC1 reaches PC3 | Success |
