...
> [!abstract]
> Address two IPv6 LANs and route between them.
...
2. Assign /64 prefixes to router LAN interfaces.
3. Configure clients with static IPv6 or SLAAC.
4. Inspect neighbor and route tables.
...
|---|---|---|
| Test 1 | Clients reach their link-local gateway | Success |
| Test 2 | End-to-end IPv6 ping succeeds | Success |
