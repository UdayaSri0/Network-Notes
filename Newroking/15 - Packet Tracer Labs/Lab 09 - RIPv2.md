...
> [!abstract]
> Exchange classless routes across three routers with RIPv2.
...
1. Build and address three routed LANs.
2. Enable RIPv2 and disable auto-summary.
3. Advertise only connected networks.
4. Inspect protocols and learned R routes.
...
|---|---|---|
| Test 1 | All routers learn remote LANs | Success |
| Test 2 | End-to-end pings succeed | Success |
