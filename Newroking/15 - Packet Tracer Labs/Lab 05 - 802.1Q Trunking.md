...
# Lab 05 - 802.1Q Trunking

> [!abstract]
> Carry VLANs 10, 20, and 30 between two switches over one trunk.
...
1. Reuse the three-VLAN access design.
2. Configure the inter-switch link as a trunk on both ends.
3. Allow VLANs 10,20,30.
4. Verify tagging behavior in Simulation Mode.
...
|---|---|---|
| Test 1 | Same-VLAN cross-switch pings succeed | Success |
| Test 2 | show interfaces trunk lists all VLANs | Success |
