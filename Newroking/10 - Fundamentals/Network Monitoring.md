...
| [[SNMP - Overview|SNMP]] | Device status, counters, and alerts |
| [[Syslog - Overview|Syslog]] | Event and diagnostic messages |
...
- [[NTP - Overview|NTP]] keeps device clocks consistent so events can be correlated.
- [[Syslog - Overview|Syslog]] sends event and diagnostic messages to a central server.
- [[SNMP - Overview|SNMP]] lets an NMS read device status and receive alerts.

---

**Parent:** [[Network Notes Home]]  
**Next:** [[NTP - Overview|NTP Overview]]
