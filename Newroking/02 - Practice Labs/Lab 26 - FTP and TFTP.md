...
> [!abstract]
> Transfer a user file with FTP and back up a Cisco configuration with TFTP.
...
1 router, 1 switch, Server0, 1 PC
...
1. Enable FTP and TFTP on Server0.
2. Create an FTP user and test transfer.
3. Copy the router running configuration to TFTP.
4. Verify filenames and restore in a controlled test.
...
|---|---|---|
| Test 1 | FTP upload/download works | Success |
| Test 2 | TFTP backup exists | Success |
