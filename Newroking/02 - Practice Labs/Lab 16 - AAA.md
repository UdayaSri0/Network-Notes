...
> [!abstract]
> Protect device login with local AAA and preserve a recovery path.
...
1. Configure management IP connectivity.
2. Create a local privileged user.
3. Enable AAA and a local login method.
4. Test a second session before closing the first.
...
|---|---|---|
| Test 1 | Authorized user logs in | Success |
| Test 2 | Invalid login is rejected | Success |
