...
> [!abstract]
> Compare rapid convergence with a redundant Rapid PVST+ topology.
...
1. Enable rapid-pvst consistently.
2. Configure root placement.
3. Identify alternate ports.
4. Measure observable convergence after a link failure.
...
|---|---|---|
| Test 1 | Rapid mode appears in summary | Success |
| Test 2 | Alternate path forwards after failure | Success |
