...
> [!abstract]
> Bundle two switch links with LACP and carry VLAN trunks over Port-channel1.
...
1. Configure identical member properties.
2. Use active on one side and passive on the other.
3. Configure Port-channel1 as a trunk.
4. Verify bundle flags and test one member failure.
...
|---|---|---|
| Test 1 | show etherchannel summary shows bundled members | Success |
| Test 2 | Traffic survives one member failure | Success |
