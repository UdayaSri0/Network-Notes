...
# Lab 02 - IPv4 Addressing

> [!abstract]
> Assign valid IPv4 addresses, masks, and gateways to two LANs connected by one router.
...
1. Create two /24 LANs.
2. Address one router interface in each LAN.
3. Configure unique PC addresses and correct gateways.
4. Verify local and routed pings.
...
| Test 2 | PC1 reaches PC2 | Success |
