...
> [!abstract]
> Translate private inside clients to an outside address with PAT.
...
2 routers, 2 switches, 2 PCs, server
...
1. Build inside and outside networks.
2. Verify routing before NAT.
3. Mark interfaces and match inside sources.
4. Generate traffic and inspect translations.
...
|---|---|---|
| Test 1 | Inside client reaches outside server | Success |
| Test 2 | PAT translation appears | Success |
