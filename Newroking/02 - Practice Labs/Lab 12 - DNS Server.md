...
> [!abstract]
> Resolve a classroom web-server name through Packet Tracer DNS.
...
1 router, 1 switch, DNS server, web server, 2 PCs
...
1. Configure static server addresses.
2. Enable DNS and create an A record.
3. Point clients to the DNS server.
4. Test name and address separately.
...
|---|---|---|
| Test 1 | nslookup returns the web server address | Success |
| Test 2 | Browser opens the named site | Success |
