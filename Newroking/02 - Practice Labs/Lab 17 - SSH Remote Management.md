---
title: "Lab 17 - SSH Remote Management"
...
# Lab 17 - SSH Remote Management

> [!abstract]
> Configure encrypted SSH-only VTY management.
...
2. Create a local admin and RSA keys.
3. Restrict VTY transport to SSH.
4. Connect from PC1 and verify the session.
...
|---|---|---|
| Test 1 | show ip ssh reports version 2 | Success |
| Test 2 | SSH login succeeds | Success |
| Test 3 | Telnet is rejected | Success |
