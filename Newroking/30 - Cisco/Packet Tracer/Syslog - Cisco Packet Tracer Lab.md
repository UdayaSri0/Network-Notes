...
- Familiarity with [[Syslog - Overview|Syslog severity levels]].
- Recommended: complete [[NTP - Cisco Packet Tracer Lab|the NTP lab]] first.
...
Manually set clocks can drift. For dependable timestamps, configure Router0 with [[NTP - Cisco Packet Tracer Lab|the NTP Packet Tracer lab]].
...
`service timestamps` adds a timestamp but does not synchronize the router clock. Complete the [[NTP - Cisco Packet Tracer Lab|NTP lab]] and verify `show ntp status`.
...
**Parent:** [[Syslog - Overview|Syslog Overview]]  
**Previous:** [[NTP - Cisco Packet Tracer Lab|Configure NTP in Cisco Packet Tracer]]  
