...
[[NTP - Overview|NTP]] is essential to useful logging. If devices have different clocks, events can appear in the wrong order and troubleshooting becomes unreliable.
...
**Practice:** [[Syslog - Cisco Packet Tracer Lab|Configure Syslog in Cisco Packet Tracer]]  
**Related:** [[NTP - Overview|NTP Overview]]
