...
> [!abstract]
> SNMP troubleshooting checks IP reachability, version, credentials, UDP 161/162, views, ACLs, and requested OIDs.
...
1. Ping the agent
2. Match manager and agent version
3. Check the exact community or user
4. Test a standard system OID

## 5. Important Terminology

- **Key idea 1:** Ping the agent
- **Key idea 2:** Match manager and agent version
- **Key idea 3:** Check the exact community or user
- **Key idea 4:** Test a standard system OID
...
1. What problem does SNMP Troubleshooting solve?
...
- **What:** SNMP troubleshooting checks IP reachability, version, credentials, UDP 161/162, views, ACLs, and requested OIDs.
