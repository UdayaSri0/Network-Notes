---
title: "SNMPv3 - Simple Network Management Protocol Version 3"
...
> [!abstract]
> SNMPv3 adds user-based authentication, integrity, and optional privacy to network management.
...
1. Create an SNMPv3 group and user
2. Choose authentication and privacy algorithms
3. Restrict views and manager access
4. Use credentials instead of community strings

## 5. Important Terminology

- **Key idea 1:** Create an SNMPv3 group and user
- **Key idea 2:** Choose authentication and privacy algorithms
- **Key idea 3:** Restrict views and manager access
- **Key idea 4:** Use credentials instead of community strings
...
1. What problem does SNMPv3 solve?
...
- **What:** SNMPv3 adds user-based authentication, integrity, and optional privacy to network management.
