---
title: "SNMPv2c - Simple Network Management Protocol Version 2c"
...
> [!abstract]
> SNMPv2c provides efficient polling and notifications but relies on unencrypted community strings.
...
1. The manager sends Get or GetNext requests
2. The agent returns MIB object values
3. Traps notify the manager without polling

## 5. Important Terminology

- **Key idea 1:** The manager sends Get or GetNext requests
- **Key idea 2:** The agent returns MIB object values
- **Key idea 3:** Traps notify the manager without polling
...
1. What problem does SNMPv2c solve?
...
- **What:** SNMPv2c provides efficient polling and notifications but relies on unencrypted community strings.
