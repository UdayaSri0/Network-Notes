...
> [!abstract]
> IPv6 troubleshooting checks interface state, prefix length, link-local addresses, router advertisements, neighbor discovery, and routing.
...
1. Inspect IPv6 interface state
2. Check neighbor cache
3. Verify RA and default route
4. Follow the IPv6 route table

## 5. Important Terminology

- **Key idea 1:** Inspect IPv6 interface state
- **Key idea 2:** Check neighbor cache
- **Key idea 3:** Verify RA and default route
- **Key idea 4:** Follow the IPv6 route table
...
1. What problem does IPv6 Troubleshooting solve?
...
- **What:** IPv6 troubleshooting checks interface state, prefix length, link-local addresses, router advertisements, neighbor discovery, and routing.
