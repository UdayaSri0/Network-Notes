...
> [!abstract]
> HSRP configuration gives two Cisco gateways one virtual IP with active and standby roles.
...
2. Configure the same group and virtual IP
3. Set intentional priorities
4. Enable preemption where required

## 5. Important Terminology

- **Key idea 1:** Use unique physical addresses
- **Key idea 2:** Configure the same group and virtual IP
- **Key idea 3:** Set intentional priorities
- **Key idea 4:** Enable preemption where required
...
1. What problem does HSRP Configuration solve?
...
- **What:** HSRP configuration gives two Cisco gateways one virtual IP with active and standby roles.
