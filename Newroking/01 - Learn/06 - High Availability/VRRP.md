...
> [!abstract]
> VRRP is a standards-based first-hop redundancy protocol with master and backup routers sharing a virtual router.
...
1. Elect a master using priority
2. Backups monitor advertisements
3. A backup takes over after master failure
4. The virtual IP remains the endpoint gateway

## 5. Important Terminology

- **Key idea 1:** Elect a master using priority
- **Key idea 2:** Backups monitor advertisements
- **Key idea 3:** A backup takes over after master failure
- **Key idea 4:** The virtual IP remains the endpoint gateway
...
- **What:** VRRP is a standards-based first-hop redundancy protocol with master and backup routers sharing a virtual router.
