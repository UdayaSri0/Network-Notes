...
> [!abstract]
> HSRP is Cisco-oriented and uses active/standby terminology, while VRRP is standards-based and uses master/backup terminology.
...
1. Both provide a virtual gateway
2. Both use priority and preemption
3. Packet Tracer support is stronger for HSRP than VRRP

## 5. Important Terminology

- **Key idea 1:** Both provide a virtual gateway
- **Key idea 2:** Both use priority and preemption
- **Key idea 3:** Packet Tracer support is stronger for HSRP than VRRP
...
1. What problem does HSRP vs VRRP solve?
...
- **What:** HSRP is Cisco-oriented and uses active/standby terminology, while VRRP is standards-based and uses master/backup terminology.
