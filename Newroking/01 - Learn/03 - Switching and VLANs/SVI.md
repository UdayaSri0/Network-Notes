...
> [!abstract]
> A switched virtual interface is a logical Layer 3 interface associated with a VLAN.
...
2. At least one member path normally must be active
3. An SVI can provide management or routed-gateway service

## 5. Important Terminology

- **Key idea 1:** The VLAN must exist
- **Key idea 2:** At least one member path normally must be active
- **Key idea 3:** An SVI can provide management or routed-gateway service
...
- **What:** A switched virtual interface is a logical Layer 3 interface associated with a VLAN.
