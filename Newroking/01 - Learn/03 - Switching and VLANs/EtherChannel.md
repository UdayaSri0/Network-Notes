...
> [!abstract]
> EtherChannel bundles compatible physical links into one logical port-channel for bandwidth and redundancy.
...
1. Member settings must match
2. A negotiation protocol or static on mode forms the bundle
3. STP treats the port-channel as one link

## 5. Important Terminology

- **Key idea 1:** Member settings must match
- **Key idea 2:** A negotiation protocol or static on mode forms the bundle
- **Key idea 3:** STP treats the port-channel as one link

## 6. Technical Classification

| Item | Value |
|---|---|
| OSI layer | Layer 2 or Layer 3 |
...
1. What problem does EtherChannel solve?
...
- **What:** EtherChannel bundles compatible physical links into one logical port-channel for bandwidth and redundancy.
