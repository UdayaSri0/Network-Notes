...
> [!abstract]
> RSTP preserves STP loop prevention while using fewer states and faster transition mechanisms.
...
1. STP uses slower timer-driven convergence
2. RSTP uses rapid role negotiation
3. Both elect a root and block redundant paths

## 5. Important Terminology

- **Key idea 1:** STP uses slower timer-driven convergence
- **Key idea 2:** RSTP uses rapid role negotiation
- **Key idea 3:** Both elect a root and block redundant paths
...
1. What problem does RSTP vs STP solve?
...
- **What:** RSTP preserves STP loop prevention while using fewer states and faster transition mechanisms.
