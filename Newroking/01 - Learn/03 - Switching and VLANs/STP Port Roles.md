...
> [!abstract]
> STP assigns root, designated, alternate, and backup roles so only a loop-free set of ports forwards.
...
1. Each non-root switch chooses one root port
2. Each segment chooses one designated port
3. Alternate and backup roles remain non-forwarding

## 5. Important Terminology

- **Key idea 1:** Each non-root switch chooses one root port
- **Key idea 2:** Each segment chooses one designated port
- **Key idea 3:** Alternate and backup roles remain non-forwarding
...
1. What problem does STP Port Roles solve?
...
- **What:** STP assigns root, designated, alternate, and backup roles so only a loop-free set of ports forwards.
