...
> [!abstract]
> IEEE 802.11 amendments define wireless bands, channel widths, modulation, spatial streams, and capabilities.
...
1. 2.4 GHz offers reach but limited non-overlapping channels
2. 5 GHz offers more channels
3. 6 GHz provides additional clean spectrum on supported devices

## 5. Important Terminology

- **Key idea 1:** 2.4 GHz offers reach but limited non-overlapping channels
- **Key idea 2:** 5 GHz offers more channels
- **Key idea 3:** 6 GHz provides additional clean spectrum on supported devices
...
1. What problem does Wi-Fi Standards solve?
...
- **What:** IEEE 802.11 amendments define wireless bands, channel widths, modulation, spatial streams, and capabilities.
