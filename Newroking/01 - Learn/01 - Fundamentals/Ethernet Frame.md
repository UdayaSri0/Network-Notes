...
> [!abstract]
> An Ethernet frame carries a Layer 3 packet across one local Layer 2 segment.
...
1. Preamble and SFD synchronize reception
2. Destination and source MAC addresses identify the local hop
3. EtherType identifies the payload
4. FCS detects corruption

## 5. Important Terminology

- **Key idea 1:** Preamble and SFD synchronize reception
- **Key idea 2:** Destination and source MAC addresses identify the local hop
- **Key idea 3:** EtherType identifies the payload
- **Key idea 4:** FCS detects corruption
...
1. What problem does Ethernet Frame solve?
...
- **What:** An Ethernet frame carries a Layer 3 packet across one local Layer 2 segment.
