...
> [!abstract]
> A MAC address identifies a network interface for local Ethernet delivery.
...
1. A 48-bit address is written in hexadecimal
2. The first portion identifies the vendor assignment
3. Switches build MAC tables from source addresses

## 5. Important Terminology

- **Key idea 1:** A 48-bit address is written in hexadecimal
- **Key idea 2:** The first portion identifies the vendor assignment
- **Key idea 3:** Switches build MAC tables from source addresses
...
1. What problem does MAC Addressing solve?
...
- **What:** A MAC address identifies a network interface for local Ethernet delivery.
