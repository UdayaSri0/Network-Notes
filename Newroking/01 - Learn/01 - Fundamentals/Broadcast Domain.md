...
1. One VLAN normally equals one broadcast domain
2. Routers and Layer 3 interfaces separate domains
3. Large domains increase broadcast scope

## 5. Important Terminology

- **Key idea 1:** One VLAN normally equals one broadcast domain
- **Key idea 2:** Routers and Layer 3 interfaces separate domains
- **Key idea 3:** Large domains increase broadcast scope
...
1. What problem does Broadcast Domain solve?
...
- **What:** A broadcast domain is the set of devices that receive the same Layer 2 broadcast.
