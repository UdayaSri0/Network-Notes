...
> [!abstract]
> Link Layer Discovery Protocol is a vendor-neutral method for discovering directly connected network devices.
...
1. Enable LLDP globally where required
2. Devices advertise chassis port and capability data
3. Neighbor information stays on the local link

## 5. Important Terminology

- **Key idea 1:** Enable LLDP globally where required
- **Key idea 2:** Devices advertise chassis port and capability data
- **Key idea 3:** Neighbor information stays on the local link
...
1. What problem does LLDP solve?
...
- **What:** Link Layer Discovery Protocol is a vendor-neutral method for discovering directly connected network devices.
