...
> [!abstract]
> TCP prioritizes reliable ordered delivery while UDP prioritizes simplicity and low overhead.
...
1. TCP establishes a session and retransmits loss
2. UDP sends independent datagrams
3. The application requirement determines the transport

## 5. Important Terminology

- **Key idea 1:** TCP establishes a session and retransmits loss
- **Key idea 2:** UDP sends independent datagrams
- **Key idea 3:** The application requirement determines the transport
...
1. What problem does TCP vs UDP solve?
...
- **What:** TCP prioritizes reliable ordered delivery while UDP prioritizes simplicity and low overhead.
