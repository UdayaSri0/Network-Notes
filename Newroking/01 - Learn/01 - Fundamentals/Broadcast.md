...
> [!abstract]
> Broadcast communication targets every host in one broadcast domain.
...
1. Ethernet broadcast uses FF:FF:FF:FF:FF:FF
2. Routers do not normally forward Layer 2 broadcasts
3. ARP and DHCP use broadcasts during discovery

## 5. Important Terminology

- **Key idea 1:** Ethernet broadcast uses FF:FF:FF:FF:FF:FF
- **Key idea 2:** Routers do not normally forward Layer 2 broadcasts
- **Key idea 3:** ARP and DHCP use broadcasts during discovery
...
1. What problem does Broadcast solve?
...
- **What:** Broadcast communication targets every host in one broadcast domain.
