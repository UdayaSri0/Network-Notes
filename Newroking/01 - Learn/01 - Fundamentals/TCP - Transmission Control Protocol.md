...
> [!abstract]
> TCP provides reliable, ordered, connection-oriented transport between applications.
...
1. SYN starts a connection
2. SYN-ACK acknowledges and synchronizes
3. ACK completes the three-way handshake
4. Sequence numbers acknowledgements and windows manage delivery

## 5. Important Terminology

- **Key idea 1:** SYN starts a connection
- **Key idea 2:** SYN-ACK acknowledges and synchronizes
- **Key idea 3:** ACK completes the three-way handshake
- **Key idea 4:** Sequence numbers acknowledgements and windows manage delivery
...
- **What:** TCP provides reliable, ordered, connection-oriented transport between applications.
