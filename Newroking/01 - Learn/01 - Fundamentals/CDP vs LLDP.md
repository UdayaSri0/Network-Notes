...
> [!abstract]
> CDP is Cisco proprietary while LLDP is the IEEE vendor-neutral discovery protocol.
...
1. Both discover directly connected neighbors
2. CDP is common in Cisco-only labs
3. LLDP improves multi-vendor interoperability

## 5. Important Terminology

- **Key idea 1:** Both discover directly connected neighbors
- **Key idea 2:** CDP is common in Cisco-only labs
- **Key idea 3:** LLDP improves multi-vendor interoperability
...
1. What problem does CDP vs LLDP solve?
...
- **What:** CDP is Cisco proprietary while LLDP is the IEEE vendor-neutral discovery protocol.
