...
> [!abstract]
> A collision domain is a shared Ethernet region where simultaneous half-duplex transmissions can interfere.
...
1. A switch creates one collision domain per port
2. Hubs place all ports in one collision domain
3. Full-duplex switched Ethernet removes collisions

## 5. Important Terminology

- **Key idea 1:** A switch creates one collision domain per port
- **Key idea 2:** Hubs place all ports in one collision domain
- **Key idea 3:** Full-duplex switched Ethernet removes collisions
...
1. What problem does Collision Domain solve?
...
- **What:** A collision domain is a shared Ethernet region where simultaneous half-duplex transmissions can interfere.
