...
> [!abstract]
> A default gateway is the local router address an endpoint uses for destinations outside its subnet.
...
1. The endpoint compares the destination with its mask
2. Local traffic is sent directly
3. Remote traffic is framed toward the gateway MAC

## 5. Important Terminology

- **Key idea 1:** The endpoint compares the destination with its mask
- **Key idea 2:** Local traffic is sent directly
- **Key idea 3:** Remote traffic is framed toward the gateway MAC
...
1. What problem does Default Gateway solve?
...
- **What:** A default gateway is the local router address an endpoint uses for destinations outside its subnet.
