...
> [!abstract]
> CIDR uses variable prefix lengths such as /24 or /27 instead of fixed address classes.
...
1. The prefix counts network bits
2. Shorter prefixes contain more addresses
3. CIDR enables aggregation and efficient allocation

## 5. Important Terminology

- **Key idea 1:** The prefix counts network bits
- **Key idea 2:** Shorter prefixes contain more addresses
- **Key idea 3:** CIDR enables aggregation and efficient allocation
...
1. What problem does CIDR solve?
...
- **What:** CIDR uses variable prefix lengths such as /24 or /27 instead of fixed address classes.
