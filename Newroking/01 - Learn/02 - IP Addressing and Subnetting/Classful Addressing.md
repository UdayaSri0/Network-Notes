...
> [!abstract]
> Classful addressing is the historical A, B, and C network model that was replaced by classless CIDR.
...
1. Class A used default /8
2. Class B used /16
3. Class C used /24
4. Modern routing carries explicit prefix lengths

## 5. Important Terminology

- **Key idea 1:** Class A used default /8
- **Key idea 2:** Class B used /16
- **Key idea 3:** Class C used /24
- **Key idea 4:** Modern routing carries explicit prefix lengths
...
1. What problem does Classful Addressing solve?
...
- **What:** Classful addressing is the historical A, B, and C network model that was replaced by classless CIDR.
