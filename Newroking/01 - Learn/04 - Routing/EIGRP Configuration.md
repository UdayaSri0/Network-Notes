...
> [!abstract]
> Classic EIGRP configuration enables one autonomous-system process and selects participating interfaces with network statements.
...
1. Use the same AS number between neighbors
2. Match the intended interfaces
3. Disable classful auto-summary in legacy IOS
4. Verify neighbors and D routes

## 5. Important Terminology

- **Key idea 1:** Use the same AS number between neighbors
- **Key idea 2:** Match the intended interfaces
- **Key idea 3:** Disable classful auto-summary in legacy IOS
- **Key idea 4:** Verify neighbors and D routes
...
1. What problem does EIGRP Configuration solve?
...
- **What:** Classic EIGRP configuration enables one autonomous-system process and selects participating interfaces with network statements.
