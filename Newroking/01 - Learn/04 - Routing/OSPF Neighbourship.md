...
> [!abstract]
> OSPF neighbors progress through defined states before becoming fully adjacent.
...
It is used in routing protocols designs, Cisco IOS teaching labs, operational verification, and fault isolation. The exact platform support depends on the selected switch, router, server, or endpoint.

## 4. How It Works

1. Down and Init establish Hello visibility
2. 2-Way confirms bidirectional communication
3. ExStart and Exchange negotiate database transfer
4. Loading requests missing LSAs
5. Full means databases are synchronized

## 5. Important Terminology

- **Key idea 1:** Down and Init establish Hello visibility
- **Key idea 2:** 2-Way confirms bidirectional communication
- **Key idea 3:** ExStart and Exchange negotiate database transfer
- **Key idea 4:** Loading requests missing LSAs
- **Key idea 5:** Full means databases are synchronized
...
1. What problem does OSPF Neighbourship solve?
...
- **What:** OSPF neighbors progress through defined states before becoming fully adjacent.
