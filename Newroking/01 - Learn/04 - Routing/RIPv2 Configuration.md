...
> [!abstract]
> RIPv2 configuration enables classless route exchange with masks and multicast updates.
...
3. Add connected major networks
4. Verify learned R routes

## 5. Important Terminology

- **Key idea 1:** Enable version 2
- **Key idea 2:** Disable automatic summarization
- **Key idea 3:** Add connected major networks
- **Key idea 4:** Verify learned R routes
...
1. What problem does RIPv2 Configuration solve?
...
- **What:** RIPv2 configuration enables classless route exchange with masks and multicast updates.
