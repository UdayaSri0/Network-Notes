...
> [!abstract]
> RIP, OSPF, and EIGRP differ in algorithm, metric, convergence, scale, complexity, and operational visibility.
...
1. RIP uses hop count and scales poorly
2. OSPF uses link state and open standards
3. EIGRP uses DUAL and Cisco-oriented operation
4. Administrative distances affect route selection

## 5. Important Terminology

- **Key idea 1:** RIP uses hop count and scales poorly
- **Key idea 2:** OSPF uses link state and open standards
- **Key idea 3:** EIGRP uses DUAL and Cisco-oriented operation
- **Key idea 4:** Administrative distances affect route selection
...
1. What problem does RIP vs OSPF vs EIGRP solve?
...
- **What:** RIP, OSPF, and EIGRP differ in algorithm, metric, convergence, scale, complexity, and operational visibility.
