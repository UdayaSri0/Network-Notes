...
> [!abstract]
> OSPF is a link-state interior gateway protocol that builds a topology database and calculates shortest paths with SPF.
...
1. Discover neighbors with Hello packets
2. Synchronize link-state databases
3. Flood LSAs within defined scope
4. Run SPF and install best routes

## 5. Important Terminology

- **Key idea 1:** Discover neighbors with Hello packets
- **Key idea 2:** Synchronize link-state databases
- **Key idea 3:** Flood LSAs within defined scope
- **Key idea 4:** Run SPF and install best routes
...
1. What problem does OSPF solve?
...
- **What:** OSPF is a link-state interior gateway protocol that builds a topology database and calculates shortest paths with SPF.
