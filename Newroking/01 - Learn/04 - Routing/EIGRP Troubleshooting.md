...
> [!abstract]
> EIGRP troubleshooting checks autonomous-system, K values, address families, passive interfaces, network statements, and reachability.
...
1. Compare neighbor-facing configuration
2. Verify EIGRP is active on the interface
3. Inspect neighbor and topology tables
4. Check route selection

## 5. Important Terminology

- **Key idea 1:** Compare neighbor-facing configuration
- **Key idea 2:** Verify EIGRP is active on the interface
- **Key idea 3:** Inspect neighbor and topology tables
- **Key idea 4:** Check route selection
...
1. What problem does EIGRP Troubleshooting solve?
...
- **What:** EIGRP troubleshooting checks autonomous-system, K values, address families, passive interfaces, network statements, and reachability.
