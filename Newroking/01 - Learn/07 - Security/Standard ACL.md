...
> [!abstract]
> A standard IPv4 ACL filters primarily by source address and is normally placed near the destination.
...
1. Match source networks with wildcard masks
2. Remember implicit deny
3. Apply in the correct direction

## 5. Important Terminology

- **Key idea 1:** Match source networks with wildcard masks
- **Key idea 2:** Remember implicit deny
- **Key idea 3:** Apply in the correct direction
...
1. What problem does Standard ACL solve?
...
- **What:** A standard IPv4 ACL filters primarily by source address and is normally placed near the destination.
