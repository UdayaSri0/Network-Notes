...
> [!abstract]
> Local AAA authenticates users against the device's own username database.
...
1. Enable the AAA model
2. Create a local privileged user
3. Define a local login method list
4. Apply it to console or VTY lines

## 5. Important Terminology

- **Key idea 1:** Enable the AAA model
- **Key idea 2:** Create a local privileged user
- **Key idea 3:** Define a local login method list
- **Key idea 4:** Apply it to console or VTY lines
...
1. What problem does Local AAA solve?
...
- **What:** Local AAA authenticates users against the device's own username database.
