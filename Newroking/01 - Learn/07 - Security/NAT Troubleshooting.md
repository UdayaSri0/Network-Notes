...
> [!abstract]
> NAT troubleshooting checks routing first, then inside/outside roles, source ACL matching, pool or interface selection, and translation counters.
...
1. Verify un-translated reachability
2. Check interface roles
3. Compare traffic against the NAT ACL
4. Inspect translations while generating traffic

## 5. Important Terminology

- **Key idea 1:** Verify un-translated reachability
- **Key idea 2:** Check interface roles
- **Key idea 3:** Compare traffic against the NAT ACL
- **Key idea 4:** Inspect translations while generating traffic
...
1. What problem does NAT Troubleshooting solve?
...
- **What:** NAT troubleshooting checks routing first, then inside/outside roles, source ACL matching, pool or interface selection, and translation counters.
