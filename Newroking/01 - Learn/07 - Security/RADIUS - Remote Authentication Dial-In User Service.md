...
> [!abstract]
> RADIUS centralizes access authentication and accounting, commonly for network access and administrative login.
...
1. The client sends credentials to a server
2. The server returns accept reject or challenge
3. Authorization attributes can accompany the response

## 5. Important Terminology

- **Key idea 1:** The client sends credentials to a server
- **Key idea 2:** The server returns accept reject or challenge
- **Key idea 3:** Authorization attributes can accompany the response
...
1. What problem does RADIUS solve?
...
- **What:** RADIUS centralizes access authentication and accounting, commonly for network access and administrative login.
