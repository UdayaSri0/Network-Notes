...
> [!abstract]
> AAA separates authentication, authorization, and accounting for controlled device access.
...
2. Authorization decides permitted actions
3. Accounting records activity

## 5. Important Terminology

- **Key idea 1:** Authentication verifies identity
- **Key idea 2:** Authorization decides permitted actions
- **Key idea 3:** Accounting records activity
...
- **What:** AAA separates authentication, authorization, and accounting for controlled device access.
