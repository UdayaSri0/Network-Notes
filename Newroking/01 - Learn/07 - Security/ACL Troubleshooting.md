...
> [!abstract]
> ACL troubleshooting checks hit counts, entry order, wildcard masks, protocol and port direction, interface placement, and implicit deny.
...
1. Reproduce one flow
2. Identify its ingress and egress path
3. Read the ACL top to bottom
4. Inspect counters and interface direction

## 5. Important Terminology

- **Key idea 1:** Reproduce one flow
- **Key idea 2:** Identify its ingress and egress path
- **Key idea 3:** Read the ACL top to bottom
- **Key idea 4:** Inspect counters and interface direction
...
1. What problem does ACL Troubleshooting solve?
...
- **What:** ACL troubleshooting checks hit counts, entry order, wildcard masks, protocol and port direction, interface placement, and implicit deny.
