...
> [!abstract]
> IP Source Guard filters access-port traffic that does not match an approved IP and MAC binding.
...
1. Build DHCP snooping bindings
2. Enable source verification on untrusted access ports
3. Handle static hosts with explicit bindings where supported

## 5. Important Terminology

- **Key idea 1:** Build DHCP snooping bindings
- **Key idea 2:** Enable source verification on untrusted access ports
- **Key idea 3:** Handle static hosts with explicit bindings where supported
...
1. What problem does IP Source Guard solve?
...
- **What:** IP Source Guard filters access-port traffic that does not match an approved IP and MAC binding.
