...
> [!abstract]
> A named ACL uses a descriptive identifier and supports sequence-based editing on suitable IOS images.
...
1. Choose standard or extended
2. Add specific permits and denies
3. Review order and implicit deny
4. Apply to an interface

## 5. Important Terminology

- **Key idea 1:** Choose standard or extended
- **Key idea 2:** Add specific permits and denies
- **Key idea 3:** Review order and implicit deny
- **Key idea 4:** Apply to an interface
...
1. What problem does Named ACL solve?
...
- **What:** A named ACL uses a descriptive identifier and supports sequence-based editing on suitable IOS images.
