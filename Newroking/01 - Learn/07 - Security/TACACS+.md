...
> [!abstract]
> TACACS+ centralizes Cisco-oriented device administration and separates authentication, authorization, and accounting exchanges.
...
1. The device contacts a TACACS+ server
2. Authorization can control individual commands
3. Most packet content is protected

## 5. Important Terminology

- **Key idea 1:** The device contacts a TACACS+ server
- **Key idea 2:** Authorization can control individual commands
- **Key idea 3:** Most packet content is protected
...
1. What problem does TACACS+ solve?
...
- **What:** TACACS+ centralizes Cisco-oriented device administration and separates authentication, authorization, and accounting exchanges.
