...
> [!abstract]
> Cisco STP configuration selects planned primary and secondary roots and verifies port roles for each VLAN.
...
1. Choose the intended root location
2. Set root primary and secondary
3. Verify roles on every redundant link
4. Test one link failure

## 5. Important Terminology

- **Key idea 1:** Choose the intended root location
- **Key idea 2:** Set root primary and secondary
- **Key idea 3:** Verify roles on every redundant link
- **Key idea 4:** Test one link failure
...
1. What problem does STP Configuration solve?
...
- **What:** Cisco STP configuration selects planned primary and secondary roots and verifies port roles for each VLAN.
