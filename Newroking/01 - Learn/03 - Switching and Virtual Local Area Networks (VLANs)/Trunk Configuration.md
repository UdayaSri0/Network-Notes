...
> [!abstract]
> A Cisco trunk carries selected VLANs between switches or between a switch and a router-on-a-stick interface.
...
1. Configure both endpoints consistently
2. Allow only required VLANs
3. Match the native VLAN if changed

## 5. Important Terminology

- **Key idea 1:** Configure both endpoints consistently
- **Key idea 2:** Allow only required VLANs
- **Key idea 3:** Match the native VLAN if changed
...
1. What problem does Trunk Configuration solve?
...
- **What:** A Cisco trunk carries selected VLANs between switches or between a switch and a router-on-a-stick interface.
