...
> [!abstract]
> Router-on-a-stick uses one physical router interface with 802.1Q subinterfaces to route between VLANs.
...
It is used in inter-vlan routing designs, Cisco IOS teaching labs, operational verification, and fault isolation. The exact platform support depends on the selected switch, router, server, or endpoint.

## 4. How It Works

1. The switch link is a trunk
2. Each subinterface maps to one VLAN
3. Each subinterface address is that VLAN's gateway

## 5. Important Terminology

- **Key idea 1:** The switch link is a trunk
- **Key idea 2:** Each subinterface maps to one VLAN
- **Key idea 3:** Each subinterface address is that VLAN's gateway

## 6. Technical Classification

| Item | Value |
|---|---|
| OSI layer | Layer 3 over 802.1Q |
...
1. What problem does Router on a Stick solve?
...
- **What:** Router-on-a-stick uses one physical router interface with 802.1Q subinterfaces to route between VLANs.
