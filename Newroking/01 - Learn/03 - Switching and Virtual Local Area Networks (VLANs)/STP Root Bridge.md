...
> [!abstract]
> The STP root bridge is the switch with the lowest bridge ID and acts as the path-cost reference for one spanning-tree instance.
...
1. Compare bridge priorities first
2. Use MAC address only to break a priority tie
3. Configure the intended root deliberately
4. Verify the Root ID on every switch

## 5. Important Terminology

- **Key idea 1:** Compare bridge priorities first
- **Key idea 2:** Use MAC address only to break a priority tie
- **Key idea 3:** Configure the intended root deliberately
- **Key idea 4:** Verify the Root ID on every switch
...
1. What problem does STP Root Bridge solve?
...
- **What:** The STP root bridge is the switch with the lowest bridge ID and acts as the path-cost reference for one spanning-tree instance.
