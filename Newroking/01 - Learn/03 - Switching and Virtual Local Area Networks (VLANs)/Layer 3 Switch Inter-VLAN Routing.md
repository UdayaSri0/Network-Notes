...
> [!abstract]
> A multilayer switch routes between VLANs using switched virtual interfaces at wire speed.
...
1. Create VLANs and access ports
2. Create an SVI gateway for each VLAN
3. Enable ip routing
4. Verify connected routes

## 5. Important Terminology

- **Key idea 1:** Create VLANs and access ports
- **Key idea 2:** Create an SVI gateway for each VLAN
- **Key idea 3:** Enable ip routing
- **Key idea 4:** Verify connected routes
...
1. What problem does Layer 3 Switch Inter-VLAN Routing solve?
...
- **What:** A multilayer switch routes between VLANs using switched virtual interfaces at wire speed.
