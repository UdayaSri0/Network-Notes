---
title: "STP Troubleshooting"
category: "Switching"
difficulty: "Intermediate"
packet_tracer_supported: "Yes"
related_protocols:
  - "[[STP - Spanning Tree Protocol]]"
  - "[[STP Blocking Problems]]"
tags:
  - networking
  - teaching
  - switching
...
> [!abstract]
> STP troubleshooting checks root placement, bridge priority, path cost, VLAN presence, trunk state, port roles, and protection features.
...
1. Identify the root seen by each switch
2. Trace the lowest-cost path
3. Inspect alternate ports
4. Check for BPDU Guard or inconsistent states

## 5. Important Terminology

- **Key idea 1:** Identify the root seen by each switch
- **Key idea 2:** Trace the lowest-cost path
- **Key idea 3:** Inspect alternate ports
- **Key idea 4:** Check for BPDU Guard or inconsistent states
...
1. What problem does STP Troubleshooting solve?
...
- **What:** STP troubleshooting checks root placement, bridge priority, path cost, VLAN presence, trunk state, port roles, and protection features.
