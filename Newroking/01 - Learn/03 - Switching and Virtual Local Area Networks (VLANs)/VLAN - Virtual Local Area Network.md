...
> [!abstract]
> A VLAN creates a logical Layer 2 broadcast domain on a switch infrastructure.
...
1. Assign a VLAN ID and name
2. Place access ports into one VLAN
3. Carry multiple VLANs across trunks
4. Route between VLANs with Layer 3 interfaces

## 5. Important Terminology

- **Key idea 1:** Assign a VLAN ID and name
- **Key idea 2:** Place access ports into one VLAN
- **Key idea 3:** Carry multiple VLANs across trunks
- **Key idea 4:** Route between VLANs with Layer 3 interfaces
...
1. What problem does VLAN solve?
...
- **What:** A VLAN creates a logical Layer 2 broadcast domain on a switch infrastructure.
