---
title: "PVST+ - Per-VLAN Spanning Tree Plus"
category: "Switching"
difficulty: "Beginner"
...
> [!abstract]
> Cisco PVST+ runs a separate classic spanning-tree instance for each VLAN.
...
1. Each VLAN can have a different root
2. 802.1Q trunks carry the instances
3. Per-VLAN tuning can distribute traffic

## 5. Important Terminology

- **Key idea 1:** Each VLAN can have a different root
- **Key idea 2:** 802.1Q trunks carry the instances
- **Key idea 3:** Per-VLAN tuning can distribute traffic
...
1. What problem does PVST+ solve?
...
- **What:** Cisco PVST+ runs a separate classic spanning-tree instance for each VLAN.
