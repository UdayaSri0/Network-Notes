...
> [!abstract]
> Cisco IOS VLAN configuration creates broadcast domains and assigns endpoint access ports.
...
1. Create VLANs before assigning ports
2. Set endpoint ports to static access mode
3. Match the access VLAN to the addressing plan

## 5. Important Terminology

- **Key idea 1:** Create VLANs before assigning ports
- **Key idea 2:** Set endpoint ports to static access mode
- **Key idea 3:** Match the access VLAN to the addressing plan
...
1. What problem does VLAN Configuration solve?
...
- **What:** Cisco IOS VLAN configuration creates broadcast domains and assigns endpoint access ports.
