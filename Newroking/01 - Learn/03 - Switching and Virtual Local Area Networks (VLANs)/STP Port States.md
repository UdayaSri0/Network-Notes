...
> [!abstract]
> STP port states control whether a port receives BPDUs, learns MAC addresses, and forwards user traffic.
...
1. Classic STP uses blocking listening learning forwarding
2. RSTP uses discarding learning forwarding
3. State transitions prevent temporary loops

## 5. Important Terminology

- **Key idea 1:** Classic STP uses blocking listening learning forwarding
- **Key idea 2:** RSTP uses discarding learning forwarding
- **Key idea 3:** State transitions prevent temporary loops
...
1. What problem does STP Port States solve?
...
- **What:** STP port states control whether a port receives BPDUs, learns MAC addresses, and forwards user traffic.
