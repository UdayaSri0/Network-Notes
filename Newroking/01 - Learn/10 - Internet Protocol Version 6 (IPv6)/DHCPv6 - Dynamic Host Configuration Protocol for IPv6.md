---
title: "DHCPv6 - Dynamic Host Configuration Protocol for IPv6"
category: "IPv6"
difficulty: "Beginner"
...
> [!abstract]
> DHCPv6 supplies stateful addresses or additional parameters, depending on router-advertisement flags and design.
...
It is used in ipv6 designs, Cisco IOS teaching labs, operational verification, and fault isolation. The exact platform support depends on the selected switch, router, server, or endpoint.

## 4. How It Works

1. Clients use multicast to discover servers or relays
2. Stateful mode leases addresses
3. Stateless mode supplies options such as DNS

## 5. Important Terminology

- **Key idea 1:** Clients use multicast to discover servers or relays
- **Key idea 2:** Stateful mode leases addresses
- **Key idea 3:** Stateless mode supplies options such as DNS
...
1. What problem does DHCPv6 solve?
...
- **What:** DHCPv6 supplies stateful addresses or additional parameters, depending on router-advertisement flags and design.
