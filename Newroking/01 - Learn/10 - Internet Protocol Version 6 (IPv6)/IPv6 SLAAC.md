...
> [!abstract]
> SLAAC lets hosts create IPv6 addresses from router advertisements without a stateful address server.
...
1. Routers advertise a prefix and flags
2. Hosts create interface identifiers
3. Duplicate Address Detection checks uniqueness
4. A link-local router can become the default gateway

## 5. Important Terminology

- **Key idea 1:** Routers advertise a prefix and flags
- **Key idea 2:** Hosts create interface identifiers
- **Key idea 3:** Duplicate Address Detection checks uniqueness
- **Key idea 4:** A link-local router can become the default gateway
...
1. What problem does IPv6 SLAAC solve?
...
- **What:** SLAAC lets hosts create IPv6 addresses from router advertisements without a stateful address server.
