...
> [!abstract]
> Cisco IOS NTP configuration points a device at a trusted time source and verifies synchronization state.
...
1. Verify reachability to the server
2. Configure the NTP server address
3. Allow polling time
4. Check association and clock source

## 5. Important Terminology

- **Key idea 1:** Verify reachability to the server
- **Key idea 2:** Configure the NTP server address
- **Key idea 3:** Allow polling time
- **Key idea 4:** Check association and clock source
...
1. What problem does Cisco NTP Configuration solve?
...
- **What:** Cisco IOS NTP configuration points a device at a trusted time source and verifies synchronization state.
