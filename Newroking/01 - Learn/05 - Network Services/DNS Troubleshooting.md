...
> [!abstract]
> DNS troubleshooting separates name-resolution failure from basic IP reachability and application failure.
...
1. Ping the DNS server by address
2. Check the client DNS setting
3. Query the exact record
4. Verify server service and record spelling

## 5. Important Terminology

- **Key idea 1:** Ping the DNS server by address
- **Key idea 2:** Check the client DNS setting
- **Key idea 3:** Query the exact record
- **Key idea 4:** Verify server service and record spelling
...
1. What problem does DNS Troubleshooting solve?
...
- **What:** DNS troubleshooting separates name-resolution failure from basic IP reachability and application failure.
