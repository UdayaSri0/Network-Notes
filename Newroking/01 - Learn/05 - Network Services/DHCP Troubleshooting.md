...
> [!abstract]
> DHCP troubleshooting follows DORA and checks client VLAN, relay address, server pool, routing, exclusions, and lease availability.
...
1. Capture or simulate DORA
2. Confirm helper is on the client gateway
3. Confirm the pool network and gateway
4. Verify return routing

## 5. Important Terminology

- **Key idea 1:** Capture or simulate DORA
- **Key idea 2:** Confirm helper is on the client gateway
- **Key idea 3:** Confirm the pool network and gateway
- **Key idea 4:** Verify return routing
...
1. What problem does DHCP Troubleshooting solve?
...
- **What:** DHCP troubleshooting follows DORA and checks client VLAN, relay address, server pool, routing, exclusions, and lease availability.
