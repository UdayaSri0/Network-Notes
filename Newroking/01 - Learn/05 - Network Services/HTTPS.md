...
> [!abstract]
> HTTPS protects HTTP with TLS authentication, integrity, and encryption.
...
1. A TLS handshake negotiates security
2. Certificates identify the server
3. Encrypted HTTP data follows

## 5. Important Terminology

- **Key idea 1:** A TLS handshake negotiates security
- **Key idea 2:** Certificates identify the server
- **Key idea 3:** Encrypted HTTP data follows
...
- **What:** HTTPS protects HTTP with TLS authentication, integrity, and encryption.
