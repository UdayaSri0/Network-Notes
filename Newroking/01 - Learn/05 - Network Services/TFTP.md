...
> [!abstract]
> TFTP is a simple unauthenticated file-transfer protocol commonly used for network-device images and configuration copies in trusted labs.
...
1. Uses UDP with a simple request-response exchange
2. Provides no login or encryption
3. Requires IP reachability and correct server path

## 5. Important Terminology

- **Key idea 1:** Uses UDP with a simple request-response exchange
- **Key idea 2:** Provides no login or encryption
- **Key idea 3:** Requires IP reachability and correct server path
...
1. What problem does TFTP solve?
...
- **What:** TFTP is a simple unauthenticated file-transfer protocol commonly used for network-device images and configuration copies in trusted labs.
