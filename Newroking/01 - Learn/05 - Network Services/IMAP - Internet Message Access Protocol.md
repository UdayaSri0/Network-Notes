...
> [!abstract]
> IMAP synchronizes server-hosted mailboxes, folders, flags, and messages across clients.
...
1. Mail remains organized on the server
2. Multiple clients share state
3. Only required content needs to be downloaded

## 5. Important Terminology

- **Key idea 1:** Mail remains organized on the server
- **Key idea 2:** Multiple clients share state
- **Key idea 3:** Only required content needs to be downloaded
...
|---|---|
| OSI layer | Layer 7 |
| Port numbers | TCP 143; secure 993 |
...
1. What problem does IMAP solve?
...
- **What:** IMAP synchronizes server-hosted mailboxes, folders, flags, and messages across clients.
