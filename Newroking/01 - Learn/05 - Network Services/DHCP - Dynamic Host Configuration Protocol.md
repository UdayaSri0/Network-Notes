...
> [!abstract]
> DHCP automatically leases IPv4 addressing information such as address, mask, gateway, DNS server, and lease time.
...
1. A client broadcasts discovery
2. A server offers a lease
3. The client requests one offer
4. The server acknowledges the binding

## 5. Important Terminology

- **Key idea 1:** A client broadcasts discovery
- **Key idea 2:** A server offers a lease
- **Key idea 3:** The client requests one offer
- **Key idea 4:** The server acknowledges the binding
...
- **What:** DHCP automatically leases IPv4 addressing information such as address, mask, gateway, DNS server, and lease time.
