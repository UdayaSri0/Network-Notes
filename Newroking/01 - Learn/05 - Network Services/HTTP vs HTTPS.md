...
> [!abstract]
> HTTP sends web traffic without TLS while HTTPS adds certificate-based authentication and encryption.
...
1. HTTP commonly uses TCP 80
2. HTTPS commonly uses TCP 443
3. HTTPS protects credentials and content in transit

## 5. Important Terminology

- **Key idea 1:** HTTP commonly uses TCP 80
- **Key idea 2:** HTTPS commonly uses TCP 443
- **Key idea 3:** HTTPS protects credentials and content in transit
...
1. What problem does HTTP vs HTTPS solve?
...
- **What:** HTTP sends web traffic without TLS while HTTPS adds certificate-based authentication and encryption.
