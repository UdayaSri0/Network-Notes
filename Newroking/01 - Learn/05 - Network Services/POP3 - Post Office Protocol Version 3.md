...
> [!abstract]
> POP3 retrieves mail with a download-oriented mailbox model.
...
2. Messages are listed and retrieved
3. Clients may delete server copies

## 5. Important Terminology

- **Key idea 1:** A client authenticates
- **Key idea 2:** Messages are listed and retrieved
- **Key idea 3:** Clients may delete server copies
...
|---|---|
| OSI layer | Layer 7 |
| Port numbers | TCP 110; secure 995 |
...
1. What problem does POP3 solve?
...
- **What:** POP3 retrieves mail with a download-oriented mailbox model.
