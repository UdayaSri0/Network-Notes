...
> [!abstract]
> NTP troubleshooting checks server reachability, UDP 123, configured peers, stratum, authentication, and elapsed polling time.
...
1. Confirm IP reachability
2. Confirm the server service is active
3. Inspect association symbols and reach
4. Wait through polling intervals

## 5. Important Terminology

- **Key idea 1:** Confirm IP reachability
- **Key idea 2:** Confirm the server service is active
- **Key idea 3:** Inspect association symbols and reach
- **Key idea 4:** Wait through polling intervals
...
1. What problem does NTP Troubleshooting solve?
...
- **What:** NTP troubleshooting checks server reachability, UDP 123, configured peers, stratum, authentication, and elapsed polling time.
