...
> [!abstract]
> A link blocks unexpectedly or the wrong root is selected; inspect bridge priorities, path costs, port roles, and topology.
...
1. What problem does STP Blocking Problems solve?
...
- **What:** A link blocks unexpectedly or the wrong root is selected; inspect bridge priorities, path costs, port roles, and topology.
