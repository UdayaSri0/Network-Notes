---
title: "OSPF Neighbour Not Forming"
...
> [!abstract]
> OSPF does not reach Full; compare subnet, area, timers, network type, authentication, MTU, passive state, and router IDs.
...
1. What problem does OSPF Neighbour Not Forming solve?
...
- **What:** OSPF does not reach Full; compare subnet, area, timers, network type, authentication, MTU, passive state, and router IDs.
