...
> [!abstract]
> GRE over IPsec combines flexible GRE encapsulation with IPsec encryption and authentication.
...
1. GRE carries multicast or multiple protocols
2. IPsec protects the GRE outer flow
3. Routing and security dependencies must both work

## 5. Important Terminology

- **Key idea 1:** GRE carries multicast or multiple protocols
- **Key idea 2:** IPsec protects the GRE outer flow
- **Key idea 3:** Routing and security dependencies must both work
...
1. What problem does GRE over IPsec solve?
...
- **What:** GRE over IPsec combines flexible GRE encapsulation with IPsec encryption and authentication.
