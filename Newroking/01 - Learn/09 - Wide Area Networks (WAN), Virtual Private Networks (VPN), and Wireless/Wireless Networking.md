...
> [!abstract]
> Wireless LANs use IEEE 802.11 radio links to connect clients through access points.
...
1. Clients discover an SSID
2. Authentication and association establish access
3. Frames share radio airtime
4. The AP bridges traffic toward the wired LAN

## 5. Important Terminology

- **Key idea 1:** Clients discover an SSID
- **Key idea 2:** Authentication and association establish access
- **Key idea 3:** Frames share radio airtime
- **Key idea 4:** The AP bridges traffic toward the wired LAN
...
1. What problem does Wireless Networking solve?
...
- **What:** Wireless LANs use IEEE 802.11 radio links to connect clients through access points.
