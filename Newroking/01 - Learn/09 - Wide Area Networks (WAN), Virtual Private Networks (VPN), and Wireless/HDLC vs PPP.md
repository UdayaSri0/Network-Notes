...
> [!abstract]
> Cisco HDLC is simple and Cisco-oriented, while PPP adds standards-based negotiation and optional PAP or CHAP authentication.
...
1. Both encapsulate point-to-point serial traffic
2. PPP provides more negotiation features
3. Interoperability and authentication often favor PPP

## 5. Important Terminology

- **Key idea 1:** Both encapsulate point-to-point serial traffic
- **Key idea 2:** PPP provides more negotiation features
- **Key idea 3:** Interoperability and authentication often favor PPP
...
1. What problem does HDLC vs PPP solve?
...
- **What:** Cisco HDLC is simple and Cisco-oriented, while PPP adds standards-based negotiation and optional PAP or CHAP authentication.
