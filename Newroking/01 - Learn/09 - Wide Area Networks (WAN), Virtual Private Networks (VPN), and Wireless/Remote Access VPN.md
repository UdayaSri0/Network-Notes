...
> [!abstract]
> A remote-access VPN securely connects an individual user device to an organizational network.
...
1. The client reaches a VPN gateway
2. User and device authenticate
3. An encrypted tunnel is established
4. Access policy limits reachable resources

## 5. Important Terminology

- **Key idea 1:** The client reaches a VPN gateway
- **Key idea 2:** User and device authenticate
- **Key idea 3:** An encrypted tunnel is established
- **Key idea 4:** Access policy limits reachable resources
...
1. What problem does Remote Access VPN solve?
...
- **What:** A remote-access VPN securely connects an individual user device to an organizational network.
