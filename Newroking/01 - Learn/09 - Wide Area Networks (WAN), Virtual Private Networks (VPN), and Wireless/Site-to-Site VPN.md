...
> [!abstract]
> A site-to-site VPN connects entire networks through security gateways.
...
2. Authenticate the peer gateways
3. Negotiate IPsec security associations
4. Route matching traffic through the tunnel

## 5. Important Terminology

- **Key idea 1:** Define interesting traffic
- **Key idea 2:** Authenticate the peer gateways
- **Key idea 3:** Negotiate IPsec security associations
- **Key idea 4:** Route matching traffic through the tunnel
...
- **What:** A site-to-site VPN connects entire networks through security gateways.
