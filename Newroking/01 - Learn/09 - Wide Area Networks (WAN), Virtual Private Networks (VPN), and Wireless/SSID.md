...
> [!abstract]
> An SSID is the human-readable identifier advertised or configured for a wireless LAN.
...
1. An SSID identifies a service set
2. Multiple SSIDs can map to different VLANs
3. Hiding the SSID is not strong security

## 5. Important Terminology

- **Key idea 1:** An SSID identifies a service set
- **Key idea 2:** Multiple SSIDs can map to different VLANs
- **Key idea 3:** Hiding the SSID is not strong security
...
1. What problem does SSID solve?
...
- **What:** An SSID is the human-readable identifier advertised or configured for a wireless LAN.
