...
> [!abstract]
> CHAP authenticates PPP peers through a challenge-response exchange without sending the shared secret directly.
...
2. The peer hashes the challenge with the secret
3. The authenticator compares the result

## 5. Important Terminology

- **Key idea 1:** The authenticator sends a random challenge
- **Key idea 2:** The peer hashes the challenge with the secret
- **Key idea 3:** The authenticator compares the result
...
1. What problem does PPP CHAP solve?
...
- **What:** CHAP authenticates PPP peers through a challenge-response exchange without sending the shared secret directly.
