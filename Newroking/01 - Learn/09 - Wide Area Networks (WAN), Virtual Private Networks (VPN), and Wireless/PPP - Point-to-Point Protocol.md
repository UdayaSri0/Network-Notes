...
> [!abstract]
> PPP is a point-to-point WAN encapsulation that supports negotiation, authentication, and multiple Layer 3 protocols.
...
2. Optional PAP or CHAP authenticates peers
3. NCP configures Layer 3 protocol use

## 5. Important Terminology

- **Key idea 1:** LCP establishes and tests the link
- **Key idea 2:** Optional PAP or CHAP authenticates peers
- **Key idea 3:** NCP configures Layer 3 protocol use
...
- **What:** PPP is a point-to-point WAN encapsulation that supports negotiation, authentication, and multiple Layer 3 protocols.
