...
> [!abstract]
> A subnet mask marks the network bits and host bits of an IPv4 address.
...
1. Binary 1 bits identify the network portion
2. Binary 0 bits identify the host portion
3. The mask determines local versus remote delivery

## 5. Important Terminology

- **Key idea 1:** Binary 1 bits identify the network portion
- **Key idea 2:** Binary 0 bits identify the host portion
- **Key idea 3:** The mask determines local versus remote delivery
...
1. What problem does Subnet Mask solve?
...
- **What:** A subnet mask marks the network bits and host bits of an IPv4 address.
