...
> [!abstract]
> BPDU Guard error-disables a protected edge port that receives a BPDU.
...
1. Enable on untrusted PortFast access ports
2. A detected switch causes shutdown
3. Remove the cause before recovering the port

## 5. Important Terminology

- **Key idea 1:** Enable on untrusted PortFast access ports
- **Key idea 2:** A detected switch causes shutdown
- **Key idea 3:** Remove the cause before recovering the port
...
1. What problem does BPDU Guard solve?
...
- **What:** BPDU Guard error-disables a protected edge port that receives a BPDU.
