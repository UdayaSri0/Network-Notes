...
> [!abstract]
> PAgP is Cisco's EtherChannel negotiation protocol using desirable and auto modes.
...
1. Desirable initiates negotiation
2. Auto responds
3. At least one side must be desirable
4. Use only between compatible Cisco devices

## 5. Important Terminology

- **Key idea 1:** Desirable initiates negotiation
- **Key idea 2:** Auto responds
- **Key idea 3:** At least one side must be desirable
- **Key idea 4:** Use only between compatible Cisco devices
...
1. What problem does PAgP solve?
...
- **What:** PAgP is Cisco's EtherChannel negotiation protocol using desirable and auto modes.
