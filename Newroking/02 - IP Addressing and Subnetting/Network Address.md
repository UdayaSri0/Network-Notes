...
> [!abstract]
> The network address identifies an IPv4 subnet and has every host bit set to zero.
...
1. Apply a bitwise AND between address and mask
2. Do not assign the network address to a host
3. Routes normally reference network prefixes

## 5. Important Terminology

- **Key idea 1:** Apply a bitwise AND between address and mask
- **Key idea 2:** Do not assign the network address to a host
- **Key idea 3:** Routes normally reference network prefixes
...
1. What problem does Network Address solve?
...
- **What:** The network address identifies an IPv4 subnet and has every host bit set to zero.
