...
**Answer:** STP prevents Layer 2 loops while retaining redundant paths.
...
### 3. Which OSI layer is most closely associated with STP?

**Answer:** See the protocol overview

### 4. Which port or protocol number is important for STP?

**Answer:** See the protocol overview

### 5. Name two important STP terms.

**Answer:** root bridge, root port, designated port, alternate port

### 6. Is STP supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring STP?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify STP?

**Answer:** show spanning-tree vlan 10

### 9. What is one common classroom mistake with STP?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove STP works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for STP.

**Answer:** Follow these core ideas in order: root bridge, root port, designated port, alternate port. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small STP lab?
...
### 10. How would you create a useful STP failure demonstration?
...
### 1. How would STP change in a larger enterprise?
...
### 2. How would you validate STP during a change window?
...
### 3. Which hidden dependency can make STP appear correctly configured but still fail?
...
### 4. How would you secure and monitor STP in production?
...
### 5. How would you teach STP without encouraging command memorization?
