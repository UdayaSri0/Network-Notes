---
title: "802.1Q Trunking Viva Questions"
...
# 802.1Q Trunking Viva Questions
...
**Answer:** IEEE 802.1Q adds VLAN identification to Ethernet frames so one link can carry multiple VLANs.

### 2. Why is 802.1Q Trunking used?
...
### 3. Which OSI layer is most closely associated with 802.1Q Trunking?

**Answer:** Layer 2

### 4. Which port or protocol number is important for 802.1Q Trunking?

**Answer:** Not applicable

### 5. Name two important 802.1Q Trunking terms.

**Answer:** Tagged frames identify their VLAN, Native VLAN traffic is normally untagged, Allowed lists control which VLANs cross the trunk

### 6. Is 802.1Q Trunking supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring 802.1Q Trunking?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify 802.1Q Trunking?

**Answer:** the relevant show command and an end-to-end test

### 9. What is one common classroom mistake with 802.1Q Trunking?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove 802.1Q Trunking works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for 802.1Q Trunking.

**Answer:** Follow these core ideas in order: Tagged frames identify their VLAN, Native VLAN traffic is normally untagged, Allowed lists control which VLANs cross the trunk. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small 802.1Q Trunking lab?
...
### 10. How would you create a useful 802.1Q Trunking failure demonstration?
...
### 1. How would 802.1Q Trunking change in a larger enterprise?
...
### 2. How would you validate 802.1Q Trunking during a change window?
...
### 3. Which hidden dependency can make 802.1Q Trunking appear correctly configured but still fail?
...
### 4. How would you secure and monitor 802.1Q Trunking in production?
...
### 5. How would you teach 802.1Q Trunking without encouraging command memorization?
