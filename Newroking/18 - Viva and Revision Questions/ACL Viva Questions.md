...
**Answer:** An access control list evaluates traffic against ordered permit and deny entries, ending with an implicit deny.
...
### 3. Which OSI layer is most closely associated with ACL?

**Answer:** Layer 3/Layer 4

### 4. Which port or protocol number is important for ACL?

**Answer:** Not applicable

### 5. Name two important ACL terms.

**Answer:** Entries are processed top to bottom, First match decides the action, Direction is relative to the interface, Placement depends on ACL type

### 6. Is ACL supported in Packet Tracer?

**Answer:** Packet Tracer Support: Yes. Always confirm the selected model and image.

### 7. What should be checked before configuring ACL?

**Answer:** Check cabling, interface state, addressing, VLANs, and baseline reachability first.

### 8. Which command can help verify ACL?

**Answer:** the relevant show command and an end-to-end test

### 9. What is one common classroom mistake with ACL?

**Answer:** Students often use the correct command on the wrong interface or with values that do not match the topology plan.

### 10. How should a student prove ACL works?

**Answer:** Show the relevant device state and then demonstrate the expected end-to-end traffic or service result.

## Intermediate Questions

### 1. Describe the operational sequence for ACL.

**Answer:** Follow these core ideas in order: Entries are processed top to bottom, First match decides the action, Direction is relative to the interface, Placement depends on ACL type. Explain the control information and resulting forwarding or service state.

### 2. How would you design a small ACL lab?
...
### 10. How would you create a useful ACL failure demonstration?
...
### 1. How would ACL change in a larger enterprise?
...
### 2. How would you validate ACL during a change window?
...
### 3. Which hidden dependency can make ACL appear correctly configured but still fail?
...
### 4. How would you secure and monitor ACL in production?
...
### 5. How would you teach ACL without encouraging command memorization?
