...
> [!abstract]
> WPA2 protects wireless access with AES-based CCMP in personal or enterprise authentication modes.
...
1. Personal mode uses a shared passphrase
2. Enterprise mode uses 802.1X and AAA
3. Strong unique credentials remain necessary

## 5. Important Terminology

- **Key idea 1:** Personal mode uses a shared passphrase
- **Key idea 2:** Enterprise mode uses 802.1X and AAA
- **Key idea 3:** Strong unique credentials remain necessary
...
1. What problem does WPA2 solve?
...
- **What:** WPA2 protects wireless access with AES-based CCMP in personal or enterprise authentication modes.
