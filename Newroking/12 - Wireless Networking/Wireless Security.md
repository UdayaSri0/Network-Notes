...
> [!abstract]
> Wireless security combines strong authentication, encryption, segmentation, radio planning, and monitoring.
...
1. Prefer WPA2-AES or WPA3
2. Separate guest and internal networks
3. Use enterprise authentication where appropriate
4. Monitor rogue access points

## 5. Important Terminology

- **Key idea 1:** Prefer WPA2-AES or WPA3
- **Key idea 2:** Separate guest and internal networks
- **Key idea 3:** Use enterprise authentication where appropriate
- **Key idea 4:** Monitor rogue access points
...
1. What problem does Wireless Security solve?
...
- **What:** Wireless security combines strong authentication, encryption, segmentation, radio planning, and monitoring.
