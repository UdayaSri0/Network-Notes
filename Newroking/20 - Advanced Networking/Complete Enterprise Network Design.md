---
title: "Complete Enterprise Network Design"
...
> [!abstract]
> A complete teaching enterprise combines hierarchical switching, routing, services, security, monitoring, redundancy, and controlled Internet access.
...
1. Separate access distribution and edge roles
2. Use documented VLAN and IP plans
3. Add services only after routing works
4. Validate with a testing matrix

## 5. Important Terminology

- **Key idea 1:** Separate access distribution and edge roles
- **Key idea 2:** Use documented VLAN and IP plans
- **Key idea 3:** Add services only after routing works
- **Key idea 4:** Validate with a testing matrix
...
1. What problem does Complete Enterprise Network Design solve?
...
- **What:** A complete teaching enterprise combines hierarchical switching, routing, services, security, monitoring, redundancy, and controlled Internet access.
