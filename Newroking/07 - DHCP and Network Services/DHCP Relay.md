...
> [!abstract]
> DHCP relay converts local client broadcasts into routed unicast messages sent to a central DHCP server.
...
1. Configure helper on the client-facing Layer 3 interface
2. Point to the server IP
3. Ensure routing works both directions
4. Match the server pool to the client subnet

## 5. Important Terminology

- **Key idea 1:** Configure helper on the client-facing Layer 3 interface
- **Key idea 2:** Point to the server IP
- **Key idea 3:** Ensure routing works both directions
- **Key idea 4:** Match the server pool to the client subnet
...
1. What problem does DHCP Relay solve?
...
- **What:** DHCP relay converts local client broadcasts into routed unicast messages sent to a central DHCP server.
