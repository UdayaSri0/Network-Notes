...
> [!abstract]
> FTP transfers files with authentication using a control connection and a separate data connection.
...
1. TCP 21 carries control commands
2. TCP 20 is associated with active-mode data
3. Credentials are not strongly protected by basic FTP

## 5. Important Terminology

- **Key idea 1:** TCP 21 carries control commands
- **Key idea 2:** TCP 20 is associated with active-mode data
- **Key idea 3:** Credentials are not strongly protected by basic FTP
...
- **What:** FTP transfers files with authentication using a control connection and a separate data connection.
