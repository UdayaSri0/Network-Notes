---
title: "Packet Tracer FTP Server"
...
# Packet Tracer FTP Server

> [!abstract]
> Packet Tracer Server-PT can provide accounts and file transfer for basic FTP demonstrations.
...
1. Set a static server address
2. Enable FTP in Services
3. Create a user and permissions
4. Connect from a PC FTP client

## 5. Important Terminology

- **Key idea 1:** Set a static server address
- **Key idea 2:** Enable FTP in Services
- **Key idea 3:** Create a user and permissions
- **Key idea 4:** Connect from a PC FTP client
...
1. What problem does Packet Tracer FTP Server solve?
...
- **What:** Packet Tracer Server-PT can provide accounts and file transfer for basic FTP demonstrations.
