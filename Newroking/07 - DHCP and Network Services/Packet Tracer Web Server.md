---
title: "Packet Tracer Web Server"
...
> [!abstract]
> Packet Tracer Server-PT can host simple HTTP and HTTPS pages for DNS and application-layer labs.
...
1. Set a static address and gateway
2. Enable HTTP or HTTPS service
3. Edit the index page
4. Browse by address and DNS name

## 5. Important Terminology

- **Key idea 1:** Set a static address and gateway
- **Key idea 2:** Enable HTTP or HTTPS service
- **Key idea 3:** Edit the index page
- **Key idea 4:** Browse by address and DNS name
...
1. What problem does Packet Tracer Web Server solve?
...
- **What:** Packet Tracer Server-PT can host simple HTTP and HTTPS pages for DNS and application-layer labs.
