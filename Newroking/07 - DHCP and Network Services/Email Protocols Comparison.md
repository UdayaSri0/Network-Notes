---
title: "Email Protocols Comparison"
...
> [!abstract]
> SMTP sends mail, while POP3 and IMAP retrieve or synchronize received mail.
...
1. SMTP handles submission and relay
2. POP3 favors simple download
3. IMAP favors synchronized server mailboxes

## 5. Important Terminology

- **Key idea 1:** SMTP handles submission and relay
- **Key idea 2:** POP3 favors simple download
- **Key idea 3:** IMAP favors synchronized server mailboxes
...
|---|---|
| OSI layer | Layer 7 |
| Port numbers | SMTP 25/587, POP3 110, IMAP 143 |
...
1. What problem does Email Protocols Comparison solve?
...
- **What:** SMTP sends mail, while POP3 and IMAP retrieve or synchronize received mail.
