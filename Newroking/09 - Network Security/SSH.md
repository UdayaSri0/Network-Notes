...
> [!abstract]
> SSH provides encrypted remote terminal access and should replace Telnet for device administration.
...
1. The server has identity keys
2. The client verifies and negotiates encryption
3. User authentication opens a protected channel

## 5. Important Terminology

- **Key idea 1:** The server has identity keys
- **Key idea 2:** The client verifies and negotiates encryption
- **Key idea 3:** User authentication opens a protected channel
...
- **What:** SSH provides encrypted remote terminal access and should replace Telnet for device administration.
