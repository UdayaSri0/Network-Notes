...
> [!abstract]
> PAT overloads many inside hosts onto one outside address by tracking transport identifiers.
...
1. Match inside sources
2. Mark inside and outside interfaces
3. Translate through the outside interface address
4. Inspect translation entries

## 5. Important Terminology

- **Key idea 1:** Match inside sources
- **Key idea 2:** Mark inside and outside interfaces
- **Key idea 3:** Translate through the outside interface address
- **Key idea 4:** Inspect translation entries
...
- **What:** PAT overloads many inside hosts onto one outside address by tracking transport identifiers.
