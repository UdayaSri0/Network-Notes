...
> [!abstract]
> SSH troubleshooting checks management IP reachability, keys, domain name, version, local users, VTY authentication, and access controls.
...
1. Ping the device management address
2. Verify RSA keys and SSH version
3. Check line vty login and transport
4. Inspect ACL restrictions

## 5. Important Terminology

- **Key idea 1:** Ping the device management address
- **Key idea 2:** Verify RSA keys and SSH version
- **Key idea 3:** Check line vty login and transport
- **Key idea 4:** Inspect ACL restrictions
...
1. What problem does SSH Troubleshooting solve?
...
- **What:** SSH troubleshooting checks management IP reachability, keys, domain name, version, local users, VTY authentication, and access controls.
