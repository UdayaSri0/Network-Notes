...
> [!abstract]
> Telnet provides legacy remote terminal access without strong encryption and should be limited to isolated teaching demonstrations.
...
1. A TCP session opens to port 23
2. Credentials and commands can be observed
3. SSH should replace it in production

## 5. Important Terminology

- **Key idea 1:** A TCP session opens to port 23
- **Key idea 2:** Credentials and commands can be observed
- **Key idea 3:** SSH should replace it in production
...
1. What problem does Telnet solve?
...
- **What:** Telnet provides legacy remote terminal access without strong encryption and should be limited to isolated teaching demonstrations.
