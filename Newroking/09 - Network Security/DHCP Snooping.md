...
> [!abstract]
> DHCP snooping blocks rogue DHCP server messages on untrusted ports and builds a trusted binding database.
...
2. Trust only legitimate server-facing paths
3. Rate-limit untrusted access ports
4. Use bindings for DAI and IP Source Guard

## 5. Important Terminology

- **Key idea 1:** Enable globally and per VLAN
- **Key idea 2:** Trust only legitimate server-facing paths
- **Key idea 3:** Rate-limit untrusted access ports
- **Key idea 4:** Use bindings for DAI and IP Source Guard
...
1. What problem does DHCP Snooping solve?
...
- **What:** DHCP snooping blocks rogue DHCP server messages on untrusted ports and builds a trusted binding database.
