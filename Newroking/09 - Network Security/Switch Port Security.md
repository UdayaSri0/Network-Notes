...
> [!abstract]
> Switch port security restricts which source MAC addresses may use an access port.
...
1. Enable on a static access port
2. Set maximum secure addresses
3. Learn sticky addresses or configure them
4. Choose protect restrict or shutdown violation mode

## 5. Important Terminology

- **Key idea 1:** Enable on a static access port
- **Key idea 2:** Set maximum secure addresses
- **Key idea 3:** Learn sticky addresses or configure them
- **Key idea 4:** Choose protect restrict or shutdown violation mode
...
1. What problem does Switch Port Security solve?
...
- **What:** Switch port security restricts which source MAC addresses may use an access port.
