...
> [!abstract]
> NAT translates addresses between inside and outside domains, commonly allowing private IPv4 networks to use public connectivity.
...
1. Classify inside and outside interfaces
2. Match inside local addresses
3. Select static dynamic or overload translation
4. Verify return traffic

## 5. Important Terminology

- **Key idea 1:** Classify inside and outside interfaces
- **Key idea 2:** Match inside local addresses
- **Key idea 3:** Select static dynamic or overload translation
- **Key idea 4:** Verify return traffic
...
- **What:** NAT translates addresses between inside and outside domains, commonly allowing private IPv4 networks to use public connectivity.
