...
> [!abstract]
> An extended IPv4 ACL can match source, destination, protocol, and transport ports and is normally placed near the source.
...
1. Select protocol
2. Match source and destination
3. Match ports where relevant
4. Apply once in the correct direction

## 5. Important Terminology

- **Key idea 1:** Select protocol
- **Key idea 2:** Match source and destination
- **Key idea 3:** Match ports where relevant
- **Key idea 4:** Apply once in the correct direction
...
1. What problem does Extended ACL solve?
...
- **What:** An extended IPv4 ACL can match source, destination, protocol, and transport ports and is normally placed near the source.
