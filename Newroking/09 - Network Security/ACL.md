...
> [!abstract]
> An access control list evaluates traffic against ordered permit and deny entries, ending with an implicit deny.
...
1. Entries are processed top to bottom
2. First match decides the action
3. Direction is relative to the interface
4. Placement depends on ACL type

## 5. Important Terminology

- **Key idea 1:** Entries are processed top to bottom
- **Key idea 2:** First match decides the action
- **Key idea 3:** Direction is relative to the interface
- **Key idea 4:** Placement depends on ACL type
...
- **What:** An access control list evaluates traffic against ordered permit and deny entries, ending with an implicit deny.
