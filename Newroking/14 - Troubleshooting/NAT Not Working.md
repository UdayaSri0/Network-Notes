...
> [!abstract]
> Translations are absent or unusable; verify routing, inside/outside roles, source ACL matching, and return reachability.
...
1. What problem does NAT Not Working solve?
...
- **What:** Translations are absent or unusable; verify routing, inside/outside roles, source ACL matching, and return reachability.
