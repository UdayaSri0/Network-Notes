---
title: "Cisco Troubleshooting Commands"
...
> [!abstract]
> Cisco show, ping, and traceroute commands reveal interface, switching, routing, service, security, and neighbor state without changing configuration.
...
2. Use the most specific show command
3. Compare expected and actual state
4. Change one cause at a time

## 5. Important Terminology

- **Key idea 1:** Capture a baseline
- **Key idea 2:** Use the most specific show command
- **Key idea 3:** Compare expected and actual state
- **Key idea 4:** Change one cause at a time
...
1. What problem does Cisco Troubleshooting Commands solve?
...
- **What:** Cisco show, ping, and traceroute commands reveal interface, switching, routing, service, security, and neighbor state without changing configuration.
