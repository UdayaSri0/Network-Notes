---
title: "PC Cannot Get DHCP Address"
...
> [!abstract]
> No valid lease is received; check access VLAN, trunk path, helper address, server pool, routing, and available addresses.
...
1. What problem does PC Cannot Get DHCP Address solve?
...
- **What:** No valid lease is received; check access VLAN, trunk path, helper address, server pool, routing, and available addresses.
