...
> [!abstract]
> GLBP provides first-hop redundancy and distributes hosts across multiple active virtual forwarders.

> [!info] Packet Tracer Support: No
> Packet Tracer is not an adequate implementation environment. Use GNS3, EVE-NG, Cisco CML, Linux, Wireshark, or real hardware.
...
It is used in redundancy and high availability designs, Cisco IOS teaching labs, operational verification, and fault isolation. The exact platform support depends on the selected switch, router, server, or endpoint.

## 4. How It Works

1. One active virtual gateway coordinates the group
2. Multiple active virtual forwarders own virtual MAC addresses
3. Clients can be balanced while redundancy remains

## 5. Important Terminology

- **Key idea 1:** One active virtual gateway coordinates the group
- **Key idea 2:** Multiple active virtual forwarders own virtual MAC addresses
- **Key idea 3:** Clients can be balanced while redundancy remains
...
|---|---|
| OSI layer | Layer 3 |
| Port numbers | UDP 3222 |
| IP protocol number | Not applicable |
| Packet Tracer support | No |
...
1. What problem does GLBP solve?
...
- **What:** GLBP provides first-hop redundancy and distributes hosts across multiple active virtual forwarders.
