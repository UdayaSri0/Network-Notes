...
> [!abstract]
> VRRP configuration creates a shared virtual router on platforms that support the required IOS feature set.
...
1. Use unique physical addresses
2. Match group and virtual IP
3. Set priority and preemption intentionally
4. Verify master and backup

## 5. Important Terminology

- **Key idea 1:** Use unique physical addresses
- **Key idea 2:** Match group and virtual IP
- **Key idea 3:** Set priority and preemption intentionally
- **Key idea 4:** Verify master and backup
...
1. What problem does VRRP Configuration solve?
...
- **What:** VRRP configuration creates a shared virtual router on platforms that support the required IOS feature set.
