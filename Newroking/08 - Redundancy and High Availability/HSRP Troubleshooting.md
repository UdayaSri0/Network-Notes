...
> [!abstract]
> HSRP troubleshooting checks shared Layer 2 reachability, group, virtual IP, version, priority, preemption, authentication, and tracking.
...
1. Confirm peers hear hello messages
2. Compare group and VIP
3. Inspect active and standby roles
4. Test the virtual gateway

## 5. Important Terminology

- **Key idea 1:** Confirm peers hear hello messages
- **Key idea 2:** Compare group and VIP
- **Key idea 3:** Inspect active and standby roles
- **Key idea 4:** Test the virtual gateway
...
1. What problem does HSRP Troubleshooting solve?
...
- **What:** HSRP troubleshooting checks shared Layer 2 reachability, group, virtual IP, version, priority, preemption, authentication, and tracking.
