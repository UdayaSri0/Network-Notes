---
title: "Cisco Syslog Configuration"
...
> [!abstract]
> Cisco IOS Syslog configuration timestamps events and sends an intentional severity range to a central collector.
...
1. Enable meaningful timestamps
2. Configure the server address
3. Choose a severity threshold
4. Generate and verify a test event

## 5. Important Terminology

- **Key idea 1:** Enable meaningful timestamps
- **Key idea 2:** Configure the server address
- **Key idea 3:** Choose a severity threshold
- **Key idea 4:** Generate and verify a test event
...
|---|---|
| OSI layer | Layer 7 |
| Port numbers | UDP 514 in Packet Tracer |
...
1. What problem does Cisco Syslog Configuration solve?
...
- **What:** Cisco IOS Syslog configuration timestamps events and sends an intentional severity range to a central collector.
