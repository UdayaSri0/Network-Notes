...
> [!abstract]
> Packet capture records traffic at an observation point for protocol analysis and evidence-based troubleshooting.
...
1. Choose an observation point
2. Capture a controlled test
3. Filter to the relevant conversation
4. Correlate packets with device state and time

## 5. Important Terminology

- **Key idea 1:** Choose an observation point
- **Key idea 2:** Capture a controlled test
- **Key idea 3:** Filter to the relevant conversation
- **Key idea 4:** Correlate packets with device state and time
...
1. What problem does Packet Capture solve?
...
- **What:** Packet capture records traffic at an observation point for protocol analysis and evidence-based troubleshooting.
