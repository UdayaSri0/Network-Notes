---
title: "Cisco SNMP Configuration"
...
> [!abstract]
> Cisco IOS SNMP configuration defines read access, device identity, and optional trap destinations.
...
1. Use a unique read-only community in labs
2. Set contact and location
3. Configure a manager for traps
4. Prefer SNMPv3 in production

## 5. Important Terminology

- **Key idea 1:** Use a unique read-only community in labs
- **Key idea 2:** Set contact and location
- **Key idea 3:** Configure a manager for traps
- **Key idea 4:** Prefer SNMPv3 in production
...
1. What problem does Cisco SNMP Configuration solve?
...
- **What:** Cisco IOS SNMP configuration defines read access, device identity, and optional trap destinations.
