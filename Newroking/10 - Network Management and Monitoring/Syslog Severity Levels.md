...
> [!abstract]
> Syslog severity ranges from 0 emergencies to 7 debugging; a threshold includes that level and every more serious level.
...
- **Key idea 1:** 0 Emergencies
- **Key idea 2:** 1 Alerts
- **Key idea 3:** 2 Critical
- **Key idea 4:** 3 Errors
- **Key idea 5:** 4 Warnings
...
1. What problem does Syslog Severity Levels solve?
...
- **What:** Syslog severity ranges from 0 emergencies to 7 debugging; a threshold includes that level and every more serious level.
