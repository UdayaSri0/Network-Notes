...
> [!abstract]
> SSH encrypts management traffic and authenticates the server, while Telnet exposes session content in clear text.
...
1. SSH uses TCP 22
2. Telnet uses TCP 23
3. Only SSH is appropriate for normal production administration

## 5. Important Terminology

- **Key idea 1:** SSH uses TCP 22
- **Key idea 2:** Telnet uses TCP 23
- **Key idea 3:** Only SSH is appropriate for normal production administration
...
1. What problem does SSH vs Telnet solve?
...
- **What:** SSH encrypts management traffic and authenticates the server, while Telnet exposes session content in clear text.
