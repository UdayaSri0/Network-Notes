...
> [!abstract]
> Dynamic NAT allocates one address from a public pool for each matching inside host while translations are active.
...
1. Define a pool
2. Match inside sources with an ACL
3. Connect the ACL to the pool
4. Mark inside and outside interfaces

## 5. Important Terminology

- **Key idea 1:** Define a pool
- **Key idea 2:** Match inside sources with an ACL
- **Key idea 3:** Connect the ACL to the pool
- **Key idea 4:** Mark inside and outside interfaces
...
1. What problem does Dynamic NAT solve?
...
- **What:** Dynamic NAT allocates one address from a public pool for each matching inside host while translations are active.
