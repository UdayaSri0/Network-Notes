...
> [!abstract]
> Trunk troubleshooting isolates mode, encapsulation, allowed-VLAN, native-VLAN, and physical-link mismatches.
...
1. Verify the operational trunk state
2. Compare both ends
3. Confirm the VLAN exists locally
4. Inspect native VLAN warnings

## 5. Important Terminology

- **Key idea 1:** Verify the operational trunk state
- **Key idea 2:** Compare both ends
- **Key idea 3:** Confirm the VLAN exists locally
- **Key idea 4:** Inspect native VLAN warnings
...
1. What problem does Trunk Troubleshooting solve?
...
- **What:** Trunk troubleshooting isolates mode, encapsulation, allowed-VLAN, native-VLAN, and physical-link mismatches.
