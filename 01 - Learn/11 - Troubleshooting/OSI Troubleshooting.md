...
> [!abstract]
> OSI troubleshooting maps symptoms and tests to Physical, Data Link, Network, Transport, and application functions.
...
1. Check link before VLAN
2. Check VLAN before IP
3. Check IP before ports
4. Check ports before application configuration

## 5. Important Terminology

- **Key idea 1:** Check link before VLAN
- **Key idea 2:** Check VLAN before IP
- **Key idea 3:** Check IP before ports
- **Key idea 4:** Check ports before application configuration
...
1. What problem does OSI Troubleshooting solve?
...
- **What:** OSI troubleshooting maps symptoms and tests to Physical, Data Link, Network, Transport, and application functions.
