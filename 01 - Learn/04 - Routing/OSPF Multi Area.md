...
> [!abstract]
> Multi-area OSPF limits link-state flooding and SPF scope by connecting non-backbone areas to area 0 through ABRs.
...
1. Area 0 is the backbone
2. ABRs maintain databases for attached areas
3. Summarization can occur at boundaries
4. Area design affects scale and recovery

## 5. Important Terminology

- **Key idea 1:** Area 0 is the backbone
- **Key idea 2:** ABRs maintain databases for attached areas
- **Key idea 3:** Summarization can occur at boundaries
- **Key idea 4:** Area design affects scale and recovery
...
1. What problem does OSPF Multi Area solve?
...
- **What:** Multi-area OSPF limits link-state flooding and SPF scope by connecting non-backbone areas to area 0 through ABRs.
