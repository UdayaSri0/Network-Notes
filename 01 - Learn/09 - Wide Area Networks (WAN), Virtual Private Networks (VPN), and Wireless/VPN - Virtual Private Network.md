...
> [!abstract]
> A virtual private network protects traffic across an untrusted network by creating an authenticated encrypted tunnel.
...
1. Peers authenticate
2. Security parameters are negotiated
3. Traffic is encapsulated and protected
4. Policies decide which traffic enters the tunnel

## 5. Important Terminology

- **Key idea 1:** Peers authenticate
- **Key idea 2:** Security parameters are negotiated
- **Key idea 3:** Traffic is encapsulated and protected
- **Key idea 4:** Policies decide which traffic enters the tunnel
...
- **What:** A virtual private network protects traffic across an untrusted network by creating an authenticated encrypted tunnel.
