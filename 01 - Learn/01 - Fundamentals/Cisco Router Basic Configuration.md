...
> [!abstract]
> A baseline router configuration establishes identity, secure administration, interface state, and saved startup configuration.
...
1. Set hostname and protected secrets
2. Configure management access
3. Address required interfaces
4. Verify and save

## 5. Important Terminology

- **Key idea 1:** Set hostname and protected secrets
- **Key idea 2:** Configure management access
- **Key idea 3:** Address required interfaces
- **Key idea 4:** Verify and save
...
1. What problem does Cisco Router Basic Configuration solve?
...
- **What:** A baseline router configuration establishes identity, secure administration, interface state, and saved startup configuration.
