...
> [!abstract]
> ICMP reports IP-layer status and errors and supports tools such as ping and traceroute.
...
1. Echo request tests reachability
2. Echo reply confirms a response
3. Destination unreachable reports a delivery problem
4. Time exceeded supports hop discovery

## 5. Important Terminology

- **Key idea 1:** Echo request tests reachability
- **Key idea 2:** Echo reply confirms a response
- **Key idea 3:** Destination unreachable reports a delivery problem
- **Key idea 4:** Time exceeded supports hop discovery
...
1. What problem does ICMP solve?
...
- **What:** ICMP reports IP-layer status and errors and supports tools such as ping and traceroute.
