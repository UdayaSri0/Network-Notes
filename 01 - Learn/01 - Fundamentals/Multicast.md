...
> [!abstract]
> Multicast delivers one stream to a selected group of interested receivers.
...
1. Senders address a group rather than each receiver
2. Network devices replicate traffic only where required
3. Control protocols also use reserved multicast groups

## 5. Important Terminology

- **Key idea 1:** Senders address a group rather than each receiver
- **Key idea 2:** Network devices replicate traffic only where required
- **Key idea 3:** Control protocols also use reserved multicast groups
...
- **What:** Multicast delivers one stream to a selected group of interested receivers.
