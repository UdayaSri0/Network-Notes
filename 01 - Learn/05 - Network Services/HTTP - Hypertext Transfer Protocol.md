...
> [!abstract]
> HTTP transfers web resources without transport encryption.
...
1. A client sends a request method and path
2. The server returns a status and content
3. Proxies and caches can participate

## 5. Important Terminology

- **Key idea 1:** A client sends a request method and path
- **Key idea 2:** The server returns a status and content
- **Key idea 3:** Proxies and caches can participate
...
- **What:** HTTP transfers web resources without transport encryption.
