...
> [!abstract]
> DNS resolves names into addresses and stores other domain information in distributed records.
...
1. A resolver sends a query
2. Recursive servers follow referrals or use cache
3. Authoritative servers answer for their zones
4. The result is cached for its TTL

## 5. Important Terminology

- **Key idea 1:** A resolver sends a query
- **Key idea 2:** Recursive servers follow referrals or use cache
- **Key idea 3:** Authoritative servers answer for their zones
- **Key idea 4:** The result is cached for its TTL
...
- **What:** DNS resolves names into addresses and stores other domain information in distributed records.
