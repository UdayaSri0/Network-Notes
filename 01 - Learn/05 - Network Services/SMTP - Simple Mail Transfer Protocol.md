...
> [!abstract]
> SMTP transfers outgoing email between clients and mail servers or between mail servers.
...
1. Clients submit mail
2. Servers relay it toward the destination domain
3. Recipients retrieve it with POP3 or IMAP

## 5. Important Terminology

- **Key idea 1:** Clients submit mail
- **Key idea 2:** Servers relay it toward the destination domain
- **Key idea 3:** Recipients retrieve it with POP3 or IMAP
...
|---|---|
| OSI layer | Layer 7 |
| Port numbers | TCP 25; submission commonly 587 |
...
1. What problem does SMTP solve?
...
- **What:** SMTP transfers outgoing email between clients and mail servers or between mail servers.
