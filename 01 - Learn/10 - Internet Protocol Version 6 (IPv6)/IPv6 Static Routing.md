...
> [!abstract]
> IPv6 static routes manually define reachability for IPv6 prefixes.
...
2. Use an outgoing interface and/or next hop
3. Use ::/0 for a default route
4. Verify recursive reachability

## 5. Important Terminology

- **Key idea 1:** Enable ipv6 unicast-routing
- **Key idea 2:** Use an outgoing interface and/or next hop
- **Key idea 3:** Use ::/0 for a default route
- **Key idea 4:** Verify recursive reachability
...
1. What problem does IPv6 Static Routing solve?
...
- **What:** IPv6 static routes manually define reachability for IPv6 prefixes.
