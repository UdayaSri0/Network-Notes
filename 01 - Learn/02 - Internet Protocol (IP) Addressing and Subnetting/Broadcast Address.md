...
> [!abstract]
> The directed broadcast address is the last address in an IPv4 subnet with every host bit set to one.
...
1. It targets all hosts in the subnet
2. It is not assigned to an endpoint
3. Routers normally restrict directed broadcasts

## 5. Important Terminology

- **Key idea 1:** It targets all hosts in the subnet
- **Key idea 2:** It is not assigned to an endpoint
- **Key idea 3:** Routers normally restrict directed broadcasts
...
1. What problem does Broadcast Address solve?
...
- **What:** The directed broadcast address is the last address in an IPv4 subnet with every host bit set to one.
