...
> [!abstract]
> Variable Length Subnet Masking assigns different prefix lengths to subnets according to their host requirements.
...
2. Allocate the largest block first
3. Continue from the next unused network boundary
4. Document unused space

## 5. Important Terminology

- **Key idea 1:** Sort requirements from largest to smallest
- **Key idea 2:** Allocate the largest block first
- **Key idea 3:** Continue from the next unused network boundary
- **Key idea 4:** Document unused space
...
1. What problem does VLSM solve?
...
- **What:** Variable Length Subnet Masking assigns different prefix lengths to subnets according to their host requirements.
